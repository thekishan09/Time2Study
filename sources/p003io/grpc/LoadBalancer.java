...
public abstract class LoadBalancer {
    ...
    public static final class PickResult {
        private static final PickResult NO_RESULT = new PickResult((Subchannel) null, (ClientStreamTracer.Factory) null, Status.f3OK, false);
        ...
        public static PickResult withSubchannel(Subchannel subchannel2, @Nullable ClientStreamTracer.Factory streamTracerFactory2) {
            return new PickResult((Subchannel) Preconditions.checkNotNull(subchannel2, "subchannel"), streamTracerFactory2, Status.f3OK, false);
        }
