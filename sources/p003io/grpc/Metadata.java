...
public final class Metadata {
    ...
    public static abstract class Key<T> {
        ...
        /* renamed from: of */
        public static <T> Key<T> m591of(String name2, BinaryMarshaller<T> marshaller2) {
            return new BinaryKey(name2, marshaller2);
        }

        /* renamed from: of */
        public static <T> Key<T> m592of(String name2, BinaryStreamMarshaller<T> marshaller2) {
            return new LazyStreamBinaryKey(name2, marshaller2);
        }

        /* renamed from: of */
        public static <T> Key<T> m590of(String name2, AsciiMarshaller<T> marshaller2) {
            return m593of(name2, false, marshaller2);
        }

        /* renamed from: of */
        static <T> Key<T> m593of(String name2, boolean pseudo, AsciiMarshaller<T> marshaller2) {
            return new AsciiKey(name2, pseudo, marshaller2);
        }

        /* renamed from: of */
        static <T> Key<T> m594of(String name2, boolean pseudo, TrustedAsciiMarshaller<T> marshaller2) {
        ...
        private Key(String name2, boolean pseudo, Object marshaller2) {
            String str = (String) Preconditions.checkNotNull(name2, "name");
