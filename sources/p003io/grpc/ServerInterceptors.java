...
public final class ServerInterceptors {
    ...
    public static <T> ServerServiceDefinition useMarshalledMessages(ServerServiceDefinition serviceDef, MethodDescriptor.Marshaller<T> marshaller) {
        ...
        ServerServiceDefinition.Builder serviceBuilder = ServerServiceDefinition.builder(new ServiceDescriptor(serviceDef.getServiceDescriptor().getName(), (Collection<MethodDescriptor<?, ?>>) wrappedDescriptors));
    ...
    private static <ReqT, RespT> void wrapAndAddMethod(p003io.grpc.ServerServiceDefinition.Builder r3, p003io.grpc.ServerMethodDefinition<ReqT, RespT> r4, java.util.List<? extends p003io.grpc.ServerInterceptor> r5) {
        /*
        ...
        L_0x0008:
            ...
            io.grpc.ServerInterceptor r2 = (p003io.grpc.ServerInterceptor) r2
            io.grpc.ServerInterceptors$InterceptCallHandler r0 = p003io.grpc.ServerInterceptors.InterceptCallHandler.create(r2, r0)
            goto L_0x0008
        L_0x0019:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p003io.grpc.ServerInterceptors.wrapAndAddMethod(io.grpc.ServerServiceDefinition$Builder, io.grpc.ServerMethodDefinition, java.util.List):void");
    }
