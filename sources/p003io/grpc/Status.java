...
public final class Status {
    ...
    static final Metadata.Key<Status> CODE_KEY = Metadata.Key.m594of("grpc-status", false, new StatusCodeMarshaller());
    ...
    /* renamed from: OK */
    public static final Status f3OK = Code.OK.toStatus();
    ...
    static {
        ...
        MESSAGE_KEY = Metadata.Key.m594of("grpc-message", false, statusMessageMarshaller);
    }
        ...
        private static byte[] toAsciiStringSlow(byte[] valueBytes, int ri) {
            ...
            while (ri < valueBytes.length) {
                ...
                if (isEscapingChar(b)) {
                    ...
                    escapedBytes[wi + 2] = bArr[b & Ascii.f322SI];
                    wi += 3;
                } else {
                    escapedBytes[wi] = b;
                    wi++;
