...
public class Http2Ping {
    ...
    public void addCallback(p003io.grpc.internal.ClientTransport.PingCallback r3, java.util.concurrent.Executor r4) {
        /*
            r2 = this;
            monitor-enter(r2)
        ...
        L_0x000c:
            ...
            java.lang.Throwable r0 = r2.failureCause     // Catch:{ all -> 0x0023 }
            java.lang.Runnable r0 = asRunnable((p003io.grpc.internal.ClientTransport.PingCallback) r3, (java.lang.Throwable) r0)     // Catch:{ all -> 0x0023 }
            goto L_0x001d
        L_0x0017:
            long r0 = r2.roundTripTimeNanos     // Catch:{ all -> 0x0023 }
            java.lang.Runnable r0 = asRunnable((p003io.grpc.internal.ClientTransport.PingCallback) r3, (long) r0)     // Catch:{ all -> 0x0023 }
        L_0x001d:
            monitor-exit(r2)     // Catch:{ all -> 0x0023 }
            doExecute(r4, r0)
            return
        L_0x0023:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p003io.grpc.internal.Http2Ping.addCallback(io.grpc.internal.ClientTransport$PingCallback, java.util.concurrent.Executor):void");
    }
    ...
    public boolean complete() {
        ...
        L_0x0023:
            ...
            io.grpc.internal.ClientTransport$PingCallback r7 = (p003io.grpc.internal.ClientTransport.PingCallback) r7
            java.lang.Runnable r7 = asRunnable((p003io.grpc.internal.ClientTransport.PingCallback) r7, (long) r1)
            doExecute(r6, r7)
            goto L_0x0023
        L_0x0043:
            return r0
        ...
        L_0x0048:
            goto L_0x0047
        */
        throw new UnsupportedOperationException("Method not decompiled: p003io.grpc.internal.Http2Ping.complete():boolean");
    }
    ...
    public void failed(java.lang.Throwable r6) {
        ...
        L_0x001a:
            ...
            io.grpc.internal.ClientTransport$PingCallback r3 = (p003io.grpc.internal.ClientTransport.PingCallback) r3
        ...
        L_0x003b:
            goto L_0x003a
        */
        throw new UnsupportedOperationException("Method not decompiled: p003io.grpc.internal.Http2Ping.failed(java.lang.Throwable):void");
    }
