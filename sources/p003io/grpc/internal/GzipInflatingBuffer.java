...
class GzipInflatingBuffer implements Closeable {
    ...
    private final GzipMetadataReader gzipMetadataReader = new GzipMetadataReader(this, (C23571) null);
    /* access modifiers changed from: private */
    ...
    private class GzipMetadataReader {
        ...
        /* synthetic */ GzipMetadataReader(GzipInflatingBuffer x0, C23571 x1) {
            this();
        }
        ...
        public int readUnsignedByte() {
            ...
            if (GzipInflatingBuffer.this.inflaterInputEnd - GzipInflatingBuffer.this.inflaterInputStart > 0) {
                b = GzipInflatingBuffer.this.inflaterInput[GzipInflatingBuffer.this.inflaterInputStart] & UnsignedBytes.MAX_VALUE;
    ...
    public int inflateBytes(byte[] b, int offset, int length) throws DataFormatException, ZipException {
        ...
        while (madeProgress) {
            ...
            int missingBytes = i;
            if (i > 0) {
                switch (C23571.$SwitchMap$io$grpc$internal$GzipInflatingBuffer$State[this.state.ordinal()]) {
                    case 1:
