...
public class MessageDeframer implements Closeable, Deframer {
    ...
    private void deliver() {
        if (!this.inDelivery) {
            ...
            while (!this.stopDelivery && this.pendingDeliveries > 0 && readRequiredBytes()) {
                try {
                    int i = C23861.$SwitchMap$io$grpc$internal$MessageDeframer$State[this.state.ordinal()];
                    if (i == 1) {
                        processHeader();
                    } else if (i == 2) {
                        processBody();
    ...
    private void processBody() {
        ...
        this.nextFrame = null;
        this.listener.messagesAvailable(new SingleMessageProducer(stream, (C23861) null));
    ...
    private static class SingleMessageProducer implements StreamListener.MessageProducer {
        ...
        /* synthetic */ SingleMessageProducer(InputStream x0, C23861 x1) {
            this(x0);
        }
