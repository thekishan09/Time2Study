...
import p003io.grpc.InternalStatus;
...
public abstract class Http2ClientStreamTransportState extends AbstractClientStream.TransportState {
    ...
    static {
        C23581 r0 = new InternalMetadata.TrustedAsciiMarshaller<Integer>() {
    ...
    private Status validateInitialMetadata(Metadata headers) {
        ...
        Status httpStatusToGrpcStatus = GrpcUtil.httpStatusToGrpcStatus(httpStatus.intValue());
        return httpStatusToGrpcStatus.augmentDescription("invalid content-type: " + contentType);
    }
