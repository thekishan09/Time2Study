...
final class RoundRobinLoadBalancer extends LoadBalancer {
    private static final Status EMPTY_OK = Status.f3OK.withDescription("no subchannels ready");
    ...
    static final class ReadyPicker extends RoundRobinPicker {
        ...
        public boolean isEquivalentTo(p003io.grpc.util.RoundRobinLoadBalancer.RoundRobinPicker r5) {
            /*
                r4 = this;
                boolean r0 = r5 instanceof p003io.grpc.util.RoundRobinLoadBalancer.ReadyPicker
                r1 = 0
                if (r0 != 0) goto L_0x0006
                return r1
            L_0x0006:
                r0 = r5
                io.grpc.util.RoundRobinLoadBalancer$ReadyPicker r0 = (p003io.grpc.util.RoundRobinLoadBalancer.ReadyPicker) r0
            ...
            L_0x0029:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p003io.grpc.util.RoundRobinLoadBalancer.ReadyPicker.isEquivalentTo(io.grpc.util.RoundRobinLoadBalancer$RoundRobinPicker):boolean");
        }
    }
