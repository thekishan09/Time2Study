...
import p003io.grpc.okhttp.internal.framed.Hpack;
...
public final class Http2 implements Variant {
    ...
    static final class Reader implements FrameReader {
        ...
        private void readPriority(FrameReader.Handler handler, int streamId) throws IOException {
            ...
            handler.priority(streamId, Integer.MAX_VALUE & w1, (this.source.readByte() & UnsignedBytes.MAX_VALUE) + 1, (Integer.MIN_VALUE & w1) != 0);
        }
    ...
    public static int readMedium(BufferedSource source) throws IOException {
        return ((source.readByte() & UnsignedBytes.MAX_VALUE) << Ascii.DLE) | ((source.readByte() & UnsignedBytes.MAX_VALUE) << 8) | (source.readByte() & UnsignedBytes.MAX_VALUE);
    }
