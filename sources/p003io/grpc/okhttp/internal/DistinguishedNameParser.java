...
final class DistinguishedNameParser {
        ...
        if (i4 < this.length) {
            ...
            if (this.chars[i4] == ' ') {
                ...
                if (cArr3[i6] != '=' || i6 == this.length) {
                    throw new IllegalStateException("Unexpected end of DN: " + this.f561dn);
                }
            }
            this.pos++;
            while (true) {
    ...
    private java.lang.String escapedAV() {
        ...
        L_0x009b:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p003io.grpc.okhttp.internal.DistinguishedNameParser.escapedAV():java.lang.String");
    }
    ...
    private int getByte(int position) {
        ...
        if (position + 1 < this.length) {
            ...
            if (b12 >= '0' && b12 <= '9') {
                ...
                throw new IllegalStateException("Malformed DN: " + this.f561dn);
            } else {
                b1 = b12 - '7';
            }
    ...
    public String findMostSpecific(String attributeType) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f561dn.toCharArray();
