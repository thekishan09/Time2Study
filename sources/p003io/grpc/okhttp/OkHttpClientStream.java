...
import p003io.grpc.internal.AbstractClientStream;
import p003io.grpc.internal.ClientStreamListener;
import p003io.grpc.internal.Http2ClientStreamTransportState;
import p003io.grpc.internal.StatsTraceContext;
import p003io.grpc.internal.TransportTracer;
import p003io.grpc.internal.WritableBuffer;
...
class OkHttpClientStream extends AbstractClientStream {
    ...
    class TransportState extends Http2ClientStreamTransportState {
        ...
        public void start(int streamId) {
            Preconditions.checkState(OkHttpClientStream.this.f560id == -1, "the stream has been started with id %s", streamId);
            int unused = OkHttpClientStream.this.f560id = streamId;
            OkHttpClientStream.this.state.onStreamAllocated();
            if (this.canStart) {
                this.frameWriter.synStream(OkHttpClientStream.this.useGet, false, OkHttpClientStream.this.f560id, 0, this.requestHeaders);
                OkHttpClientStream.this.statsTraceCtx.clientOutboundHeaders();
                this.requestHeaders = null;
                if (this.pendingData.size() > 0) {
                    this.outboundFlow.data(this.pendingDataHasEndOfStream, OkHttpClientStream.this.f560id, this.pendingData, this.flushPendingData);
                }
                this.canStart = false;
            }
        }
        ...
        public void bytesRead(int processedBytes) {
            ...
            if (((float) i) <= ((float) i2) * 0.5f) {
                ...
                this.frameWriter.windowUpdate(OkHttpClientStream.this.mo32823id(), (long) delta);
            }
        }
        ...
        public void transportDataReceived(Buffer frame, boolean endOfStream) {
            ...
            this.window = size;
            if (size < 0) {
                this.frameWriter.rstStream(OkHttpClientStream.this.mo32823id(), ErrorCode.FLOW_CONTROL_ERROR);
                this.transport.finishStream(OkHttpClientStream.this.mo32823id(), Status.INTERNAL.withDescription("Received data size exceeded our receiving window size"), ClientStreamListener.RpcProgress.PROCESSED, false, (ErrorCode) null, (Metadata) null);
                return;
            }
        ...
        private void onEndOfStream() {
            if (!isOutboundClosed()) {
                this.transport.finishStream(OkHttpClientStream.this.mo32823id(), (Status) null, ClientStreamListener.RpcProgress.PROCESSED, false, ErrorCode.CANCEL, (Metadata) null);
            } else {
                this.transport.finishStream(OkHttpClientStream.this.mo32823id(), (Status) null, ClientStreamListener.RpcProgress.PROCESSED, false, (ErrorCode) null, (Metadata) null);
            }
        }
        ...
        public void cancel(Status reason, boolean stopDelivery, Metadata trailers) {
            if (!this.cancelSent) {
                ...
                this.transport.finishStream(OkHttpClientStream.this.mo32823id(), reason, ClientStreamListener.RpcProgress.PROCESSED, stopDelivery, ErrorCode.CANCEL, trailers);
            }
        }
        ...
        public void sendBuffer(Buffer buffer, boolean endOfStream, boolean flush) {
            if (!this.cancelSent) {
                ...
                Preconditions.checkState(OkHttpClientStream.this.mo32823id() != -1, "streamId should be set");
                this.outboundFlow.data(endOfStream, OkHttpClientStream.this.mo32823id(), buffer, flush);
            }
        }
