...
import p003io.grpc.internal.TransportFrameUtil;
...
class Utils {
    ...
    static ConnectionSpec convertSpec(com.squareup.okhttp.ConnectionSpec spec) {
        ...
        p003io.grpc.okhttp.internal.CipherSuite[] cipherSuites = new p003io.grpc.okhttp.internal.CipherSuite[cipherSuiteList.size()];
        for (int i2 = 0; i2 < cipherSuites.length; i2++) {
            cipherSuites[i2] = p003io.grpc.okhttp.internal.CipherSuite.valueOf(cipherSuiteList.get(i2).name());
        }
