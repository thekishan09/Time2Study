...
import p003io.grpc.internal.Http2Ping;
...
import p003io.grpc.internal.SerializingExecutor;
...
import p003io.grpc.okhttp.ExceptionHandlingFrameWriter;
import p003io.grpc.okhttp.OkHttpFrameLogger;
import p003io.grpc.okhttp.internal.ConnectionSpec;
import p003io.grpc.okhttp.internal.framed.ErrorCode;
import p003io.grpc.okhttp.internal.framed.FrameReader;
import p003io.grpc.okhttp.internal.framed.FrameWriter;
import p003io.grpc.okhttp.internal.framed.Header;
import p003io.grpc.okhttp.internal.framed.HeadersMode;
import p003io.grpc.okhttp.internal.framed.Http2;
import p003io.grpc.okhttp.internal.framed.Settings;
import p003io.grpc.okhttp.internal.framed.Variant;
...
class OkHttpClientTransport implements ConnectionClientTransport, ExceptionHandlingFrameWriter.TransportExceptionHandler {
    ...
    public void ping(p003io.grpc.internal.ClientTransport.PingCallback r10, java.util.concurrent.Executor r11) {
        /*
            r9 = this;
            r0 = 0
        ...
        L_0x000d:
            ...
            p003io.grpc.internal.Http2Ping.notifyFailed(r10, r11, r3)     // Catch:{ all -> 0x0058 }
        ...
        L_0x0046:
            ...
            r7 = 32
            long r7 = r0 >>> r7
            int r8 = (int) r7     // Catch:{ all -> 0x0058 }
            int r7 = (int) r0     // Catch:{ all -> 0x0058 }
            r6.ping(r4, r8, r7)     // Catch:{ all -> 0x0058 }
        L_0x0053:
            monitor-exit(r2)     // Catch:{ all -> 0x0058 }
            r3.addCallback(r10, r11)
            return
        L_0x0058:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: p003io.grpc.okhttp.OkHttpClientTransport.ping(io.grpc.internal.ClientTransport$PingCallback, java.util.concurrent.Executor):void");
    }
    ...
    public OkHttpClientStream newStream(MethodDescriptor<?, ?> method, Metadata headers, CallOptions callOptions) {
        ...
        synchronized (obj2) {
            try {
                ...
                obj = obj2;
                OkHttpClientStream okHttpClientStream = new OkHttpClientStream(method, headers, exceptionHandlingFrameWriter, this, outboundFlowController, obj3, i, i2, str, str2, statsTraceCtx, transportTracer2, callOptions, this.useGetForSafeMethods);
    ...
    private void startStream(OkHttpClientStream stream) {
        Preconditions.checkState(stream.mo32823id() == -1, "StreamId already assigned");
    ...
    class ClientFrameHandler implements FrameReader.Handler, Runnable {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:21:0x006c, code lost:
            r1 = r10.this$0;
            r2 = p003io.grpc.okhttp.internal.framed.ErrorCode.PROTOCOL_ERROR;
            p003io.grpc.okhttp.OkHttpClientTransport.access$2200(r1, r2, "Received window_update for unknown stream: " + r11);
         */
        ...
        public void windowUpdate(int r11, long r12) {
            /*
                ...
                io.grpc.okhttp.OkHttpFrameLogger$Direction r1 = p003io.grpc.okhttp.OkHttpFrameLogger.Direction.INBOUND
                ...
                io.grpc.okhttp.OkHttpClientTransport r1 = p003io.grpc.okhttp.OkHttpClientTransport.this
                io.grpc.okhttp.internal.framed.ErrorCode r2 = p003io.grpc.okhttp.internal.framed.ErrorCode.PROTOCOL_ERROR
                r1.onError(r2, r0)
                goto L_0x002b
            L_0x0019:
                io.grpc.okhttp.OkHttpClientTransport r3 = p003io.grpc.okhttp.OkHttpClientTransport.this
                io.grpc.Status r1 = p003io.grpc.Status.INTERNAL
                io.grpc.Status r5 = r1.withDescription(r0)
                io.grpc.internal.ClientStreamListener$RpcProgress r6 = p003io.grpc.internal.ClientStreamListener.RpcProgress.PROCESSED
                r7 = 0
                io.grpc.okhttp.internal.framed.ErrorCode r8 = p003io.grpc.okhttp.internal.framed.ErrorCode.PROTOCOL_ERROR
                r9 = 0
                r4 = r11
            ...
            L_0x002c:
                ...
                io.grpc.okhttp.OkHttpClientTransport r2 = p003io.grpc.okhttp.OkHttpClientTransport.this     // Catch:{ all -> 0x0085 }
            ...
            L_0x0043:
                ...
                io.grpc.okhttp.OkHttpClientStream r2 = (p003io.grpc.okhttp.OkHttpClientStream) r2     // Catch:{ all -> 0x0085 }
                if (r2 == 0) goto L_0x0060
                io.grpc.okhttp.OkHttpClientTransport r3 = p003io.grpc.okhttp.OkHttpClientTransport.this     // Catch:{ all -> 0x0085 }
            ...
            L_0x0085:
                ...
                throw r2
            */
            throw new UnsupportedOperationException("Method not decompiled: p003io.grpc.okhttp.OkHttpClientTransport.ClientFrameHandler.windowUpdate(int, long):void");
        }
