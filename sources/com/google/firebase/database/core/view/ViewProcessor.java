...
public class ViewProcessor {
    ...
    public ProcessorResult applyOperation(ViewCache oldViewCache, Operation operation, WriteTreeRef writesCache, Node optCompleteCache) {
        ...
        int i = C18682.f403xc0d7b136[operation.getType().ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C18682 {
        ...
        static {
            ...
            try {
                f403xc0d7b136[Operation.OperationType.Merge.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f403xc0d7b136[Operation.OperationType.AckUserWrite.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f403xc0d7b136[Operation.OperationType.ListenComplete.ordinal()] = 4;
