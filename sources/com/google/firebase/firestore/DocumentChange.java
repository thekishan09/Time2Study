...
public class DocumentChange {
    ...
    static /* synthetic */ class C18831 {
        ...
        static final /* synthetic */ int[] f408x33862af7;
        ...
        static {
            ...
            try {
                f408x33862af7[DocumentViewChange.Type.METADATA.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f408x33862af7[DocumentViewChange.Type.MODIFIED.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f408x33862af7[DocumentViewChange.Type.REMOVED.ordinal()] = 4;
    ...
    private static Type getType(DocumentViewChange change) {
        int i = C18831.f408x33862af7[change.getType().ordinal()];
        if (i == 1) {
            return Type.ADDED;
        }
        if (i == 2 || i == 3) {
