...
public class WatchChangeAggregator {
    ...
    public void handleTargetChange(WatchChange.WatchTargetChange targetChange) {
        for (Integer intValue : getTargetIds(targetChange)) {
            ...
            int i = C19251.f442x3bf9e295[targetChange.getChangeType().ordinal()];
            boolean z = true;
            if (i != 1) {
                if (i == 2) {
    ...
    static /* synthetic */ class C19251 {
        ...
        static {
            ...
            try {
                f442x3bf9e295[WatchChange.WatchTargetChangeType.Added.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f442x3bf9e295[WatchChange.WatchTargetChangeType.Removed.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f442x3bf9e295[WatchChange.WatchTargetChangeType.Current.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f442x3bf9e295[WatchChange.WatchTargetChangeType.Reset.ordinal()] = 5;
