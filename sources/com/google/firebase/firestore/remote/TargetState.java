...
final class TargetState {
    ...
    public TargetChange toTargetChange() {
        ...
        for (Map.Entry<DocumentKey, DocumentViewChange.Type> entry : this.documentChanges.entrySet()) {
            ...
            int i = C19231.f441x33862af7[changeType.ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C19231 {
        ...
        static final /* synthetic */ int[] f441x33862af7;
        ...
        static {
            ...
            try {
                f441x33862af7[DocumentViewChange.Type.MODIFIED.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f441x33862af7[DocumentViewChange.Type.REMOVED.ordinal()] = 3;
