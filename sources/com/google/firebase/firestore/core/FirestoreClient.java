...
public final class FirestoreClient {
    ...
    static /* synthetic */ void lambda$new$0(FirestoreClient firestoreClient, TaskCompletionSource firstUser, Context context, FirebaseFirestoreSettings settings) {
        try {
            firestoreClient.initialize(context, (User) Tasks.await(firstUser.getTask()), settings);
    ...
    private void initialize(Context context, User user, FirebaseFirestoreSettings settings) {
        ...
        ComponentProvider.Configuration configuration = new ComponentProvider.Configuration(context2, asyncQueue2, databaseInfo2, new Datastore(this.databaseInfo, this.asyncQueue, this.credentialsProvider, context, this.metadataProvider), user, 100, settings);
        ...
        this.gcScheduler = provider.getGargabeCollectionScheduler();
    ...
    public void removeSnapshotsInSyncListener(EventListener<Void> listener) {
        if (!isTerminated()) {
            this.asyncQueue.enqueueAndForget(FirestoreClient$$Lambda$15.lambdaFactory$(this, listener));
        }
    }
