    ...
    public Target toTarget() {
        ...
        if (this.memoizedTarget == null) {
            if (this.limitType == LimitType.LIMIT_TO_FIRST) {
                ...
                Bound newStartAt = this.endAt != null ? new Bound(this.endAt.getPosition(), !this.endAt.isBefore()) : null;
                if (this.startAt != null) {
                    newEndAt = new Bound(this.startAt.getPosition(), !this.startAt.isBefore());
                } else {
                    newEndAt = null;
                }
