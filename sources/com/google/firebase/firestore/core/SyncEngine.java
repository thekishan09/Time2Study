...
public class SyncEngine implements RemoteStore.RemoteStoreCallback {
    ...
    public void stopListening(Query query) {
        ...
        if (targetQueries.isEmpty()) {
            ...
            removeAndCleanupTarget(targetId, Status.f3OK);
        }
    }
    ...
    private void notifyUser(int r5, p003io.grpc.Status r6) {
        /*
            r4 = this;
    ...
    static /* synthetic */ class C18941 {
        ...
        static final /* synthetic */ int[] f413x84ba890d;
        ...
        static {
            ...
            try {
                f413x84ba890d[LimboDocumentChange.Type.REMOVED.ordinal()] = 2;
    ...
    private void updateTrackedLimboDocuments(List<LimboDocumentChange> limboChanges, int targetId) {
        for (LimboDocumentChange limboChange : limboChanges) {
            int i = C18941.f413x84ba890d[limboChange.getType().ordinal()];
            if (i == 1) {
