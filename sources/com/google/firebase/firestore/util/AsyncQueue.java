...
public class AsyncQueue {
    ...
    private class SynchronizedShutdownAwareExecutor implements Executor {
        ...
        SynchronizedShutdownAwareExecutor() {
            ...
            C00041 r1 = new ScheduledThreadPoolExecutor(1, threadFactory, AsyncQueue.this) {
    ...
    static /* synthetic */ void lambda$panic$3(Throwable t) {
        if (t instanceof OutOfMemoryError) {
            OutOfMemoryError error = new OutOfMemoryError("Firestore (21.5.0) ran out of memory. Check your queries to make sure they are not loading an excessive amount of data.");
            error.initCause(t);
            throw error;
        }
        throw new RuntimeException("Internal error in Cloud Firestore (21.5.0).", t);
    }
