...
final class zzas {
    ...
    public static Map<String, Object> zza(String str) {
        ...
        if (zza2.size() < 2) {
            ...
            logger.mo11929e(valueOf.length() != 0 ? "Invalid idToken ".concat(valueOf) : new String("Invalid idToken "), new Object[0]);
            return zzbk.zza();
        }
        try {
            ...
            zza.mo11928e("Unable to decode token", e, new Object[0]);
            return zzbk.zza();
        }
    }
