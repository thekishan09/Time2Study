...
final class zzbs extends zzff<AuthResult, zzb> {
    ...
    public final /* synthetic */ void zza(zzeh zzeh, TaskCompletionSource taskCompletionSource) throws RemoteException {
        ...
        zzds zzds = new zzds(this.zza.zza(this.zze));
        if (this.zzu) {
            zzeh.zza().zza(zzds.zza(), (zzem) this.zzc);
        } else {
            zzeh.zza().zza(zzds, (zzem) this.zzc);
        }
    }
}
