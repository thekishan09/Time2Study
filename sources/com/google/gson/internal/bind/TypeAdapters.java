...
public final class TypeAdapters {
    ...
    public static final TypeAdapterFactory ENUM_FACTORY = new TypeAdapterFactory() {
        ...
        public <T> com.google.gson.TypeAdapter<T> create(com.google.gson.Gson r3, com.google.gson.reflect.TypeToken<T> r4) {
            ...
            L_0x0021:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C206130.create(com.google.gson.Gson, com.google.gson.reflect.TypeToken):com.google.gson.TypeAdapter");
        }
    };
    ...
    static {
        ...
        TypeAdapter<BitSet> nullSafe2 = new TypeAdapter<BitSet>() {
            public BitSet read(JsonReader in) throws IOException {
                ...
                while (tokenType != JsonToken.END_ARRAY) {
                    int i2 = C206836.$SwitchMap$com$google$gson$stream$JsonToken[tokenType.ordinal()];
                    boolean set = false;
                    if (i2 != 1) {
                        if (i2 == 2) {
                            set = in.nextBoolean();
        ...
        C204214 r0 = new TypeAdapter<Number>() {
            public Number read(JsonReader in) throws IOException {
                JsonToken jsonToken = in.peek();
                int i = C206836.$SwitchMap$com$google$gson$stream$JsonToken[jsonToken.ordinal()];
                if (i == 1 || i == 3) {
        ...
        C204719 r02 = new TypeAdapter<StringBuilder>() {
        ...
        C204920 r03 = new TypeAdapter<StringBuffer>() {
        ...
        C205021 r04 = new TypeAdapter<URL>() {
        ...
        C205122 r05 = new TypeAdapter<URI>() {
        ...
        C205223 r06 = new TypeAdapter<InetAddress>() {
        ...
        C205324 r07 = new TypeAdapter<UUID>() {
        ...
        C205727 r08 = new TypeAdapter<Calendar>() {
        ...
        C205828 r09 = new TypeAdapter<Locale>() {
        ...
        C205929 r010 = new TypeAdapter<JsonElement>() {
            public JsonElement read(JsonReader in) throws IOException {
                switch (C206836.$SwitchMap$com$google$gson$stream$JsonToken[in.peek().ordinal()]) {
                    case 1:
    ...
    static /* synthetic */ class C206836 {
