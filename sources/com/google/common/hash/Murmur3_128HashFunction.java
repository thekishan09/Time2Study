...
final class Murmur3_128HashFunction extends AbstractHashFunction implements Serializable {
    ...
    private static final class Murmur3_128Hasher extends AbstractStreamingHasher {
        ...
        /* renamed from: C1 */
        private static final long f358C1 = -8663945395140668459L;

        /* renamed from: C2 */
        private static final long f359C2 = 5545529020109919103L;
        ...
        Murmur3_128Hasher(int seed) {
            super(16);
            this.f360h1 = (long) seed;
            this.f361h2 = (long) seed;
        }
        ...
        private void bmix64(long k1, long k2) {
            long mixK1 = this.f360h1 ^ mixK1(k1);
            this.f360h1 = mixK1;
            long rotateLeft = Long.rotateLeft(mixK1, 27);
            this.f360h1 = rotateLeft;
            long j = this.f361h2;
            long j2 = rotateLeft + j;
            this.f360h1 = j2;
            this.f360h1 = (j2 * 5) + 1390208809;
            long mixK2 = mixK2(k2) ^ j;
            this.f361h2 = mixK2;
            long rotateLeft2 = Long.rotateLeft(mixK2, 31);
            this.f361h2 = rotateLeft2;
            long j3 = rotateLeft2 + this.f360h1;
            this.f361h2 = j3;
            this.f361h2 = (j3 * 5) + 944331445;
        }
        ...
        public HashCode makeHash() {
            ...
            long j2 = j ^ ((long) i);
            this.f360h1 = j2;
            long j3 = this.f361h2 ^ ((long) i);
            this.f361h2 = j3;
            long j4 = j2 + j3;
            this.f360h1 = j4;
            this.f361h2 = j3 + j4;
            this.f360h1 = fmix64(j4);
            long fmix64 = fmix64(this.f361h2);
            this.f361h2 = fmix64;
            long j5 = this.f360h1 + fmix64;
            this.f360h1 = j5;
            this.f361h2 = fmix64 + j5;
            return HashCode.fromBytesNoCopy(ByteBuffer.wrap(new byte[16]).order(ByteOrder.LITTLE_ENDIAN).putLong(this.f360h1).putLong(this.f361h2).array());
        }
        ...
        private static long mixK1(long k1) {
            return Long.rotateLeft(k1 * f358C1, 31) * f359C2;
        }

        private static long mixK2(long k2) {
            return Long.rotateLeft(k2 * f359C2, 33) * f358C1;
        }
    }
}
