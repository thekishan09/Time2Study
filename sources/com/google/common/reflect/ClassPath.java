...
public final class ClassPath {
    ...
    public static final Splitter CLASS_PATH_ATTRIBUTE_SEPARATOR = Splitter.m412on(" ").omitEmptyStrings();
    ...
    public static class ResourceInfo {
        ...
        /* renamed from: of */
        static ResourceInfo m564of(String resourceName2, ClassLoader loader2) {
    ...
    static abstract class Scanner {
        ...
        static ImmutableList<URL> parseJavaClassPath() {
            ...
            for (String entry : Splitter.m412on(StandardSystemProperty.PATH_SEPARATOR.value()).split(StandardSystemProperty.JAVA_CLASS_PATH.value())) {
                try {
    ...
    static final class DefaultScanner extends Scanner {
        ...
        public ImmutableSet<ResourceInfo> getResources() {
            ...
            for (Map.Entry<ClassLoader, String> entry : this.resources.entries()) {
                builder.add((Object) ResourceInfo.m564of(entry.getValue(), entry.getKey()));
            }
            return builder.build();
        }
