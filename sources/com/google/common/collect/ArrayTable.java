...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    /* renamed from: at */
    public V mo19158at(int rowIndex, int columnIndex) {
    ...
    public V get(@NullableDecl Object rowKey, @NullableDecl Object columnKey) {
        ...
        return mo19158at(rowIndex.intValue(), columnIndex.intValue());
    }
    ...
    public Table.Cell<R, C, V> getCell(final int index) {
        return new Tables.AbstractCell<R, C, V>() {
            ...
            public V getValue() {
                return ArrayTable.this.mo19158at(this.rowIndex, this.columnIndex);
            }
        };
    }
    ...
    public V getValue(int index) {
        return mo19158at(index / this.columnList.size(), index % this.columnList.size());
    }

    public Map<R, V> column(C columnKey) {
        Preconditions.checkNotNull(columnKey);
        Integer columnIndex = this.columnKeyToIndex.get(columnKey);
        return columnIndex == null ? ImmutableMap.m446of() : new Column(columnIndex.intValue());
    }
    ...
    private class Column extends ArrayMap<R, V> {
        ...
        /* access modifiers changed from: package-private */
        public V getValue(int index) {
            return ArrayTable.this.mo19158at(index, this.columnIndex);
        }
    ...
    public Map<C, V> row(R rowKey) {
        Preconditions.checkNotNull(rowKey);
        Integer rowIndex = this.rowKeyToIndex.get(rowKey);
        return rowIndex == null ? ImmutableMap.m446of() : new Row(rowIndex.intValue());
    }
    ...
    private class Row extends ArrayMap<C, V> {
        ...
        /* access modifiers changed from: package-private */
        public V getValue(int index) {
            return ArrayTable.this.mo19158at(this.rowIndex, index);
        }
