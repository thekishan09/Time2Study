...
public abstract class ContiguousSet<C extends Comparable> extends ImmutableSortedSet<C> {
    ...
    public static <C extends Comparable> ContiguousSet<C> create(Range<C> range, DiscreteDomain<C> domain2) {
        ...
        try {
            ...
            return effectiveRange.isEmpty() || Range.compareOrThrow(range.lowerBound.leastValueAbove(domain2), range.upperBound.greatestValueBelow(domain2)) > 0 ? new EmptyContiguousSet(domain2) : new RegularContiguousSet(effectiveRange, domain2);
