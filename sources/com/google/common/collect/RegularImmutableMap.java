...
final class RegularImmutableMap<K, V> extends ImmutableMap<K, V> {
    ...
    private static IllegalArgumentException duplicateKeyException(Object key, Object value, Object[] alternatingKeysAndValues2, int previousKeyIndex) {
        return new IllegalArgumentException("Multiple entries with same key: " + key + "=" + value + " and " + alternatingKeysAndValues2[previousKeyIndex] + "=" + alternatingKeysAndValues2[previousKeyIndex ^ 1]);
    }
