...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    private Iterable<E> getDelegate() {
        return this.iterableDelegate.mo18233or(this);
    }
    ...
    /* renamed from: of */
    public static <E> FluentIterable<E> m417of() {
        return from(ImmutableList.m427of());
    }

    /* renamed from: of */
    public static <E> FluentIterable<E> m418of(@NullableDecl E element, E... elements) {
    ...
    public final Optional<E> first() {
        ...
        return iterator.hasNext() ? Optional.m398of(iterator.next()) : Optional.absent();
    }
    ...
    public final Optional<E> last() {
        ...
        if (iterable instanceof List) {
            ...
            return Optional.m398of(list.get(list.size() - 1));
        }
        ...
        if (iterable instanceof SortedSet) {
            return Optional.m398of(((SortedSet) iterable).last());
        }
        do {
            current = iterator.next();
        } while (iterator.hasNext());
        return Optional.m398of(current);
    }
