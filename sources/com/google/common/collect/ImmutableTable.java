...
public abstract class ImmutableTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    /* renamed from: of */
    public static <R, C, V> ImmutableTable<R, C, V> m520of() {
        return SparseImmutableTable.EMPTY;
    }

    /* renamed from: of */
    public static <R, C, V> ImmutableTable<R, C, V> m521of(R rowKey, C columnKey, V value) {
    ...
    public ImmutableMap<R, V> column(C columnKey) {
        ...
        return (ImmutableMap) MoreObjects.firstNonNull((ImmutableMap) columnMap().get(columnKey), ImmutableMap.m446of());
    }
    ...
    public ImmutableMap<C, V> row(R rowKey) {
        ...
        return (ImmutableMap) MoreObjects.firstNonNull((ImmutableMap) rowMap().get(rowKey), ImmutableMap.m446of());
    }
    ...
    static final class SerializedForm implements Serializable {
        ...
        public Object readResolve() {
            ...
            if (objArr.length == 1) {
                return ImmutableTable.m521of(this.rowKeys[0], this.columnKeys[0], objArr[0]);
            }
            ...
            while (true) {
                ...
                cellListBuilder.add((Object) ImmutableTable.cellOf(this.rowKeys[this.cellRowIndices[i]], this.columnKeys[this.cellColumnIndices[i]], objArr2[i]));
                i++;
            }
        }
    }
