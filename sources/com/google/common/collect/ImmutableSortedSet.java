...
public abstract class ImmutableSortedSet<E> extends ImmutableSortedSetFauxverideShim<E> implements NavigableSet<E>, SortedIterable<E> {
    ...
    static <E> RegularImmutableSortedSet<E> emptySet(Comparator<? super E> comparator2) {
        ...
        return new RegularImmutableSortedSet<>(ImmutableList.m427of(), comparator2);
    }

    /* renamed from: of */
    public static <E> ImmutableSortedSet<E> m507of() {
        return RegularImmutableSortedSet.NATURAL_EMPTY_SET;
    }

    /* renamed from: of */
    public static <E extends Comparable<? super E>> ImmutableSortedSet<E> m508of(E element) {
        return new RegularImmutableSortedSet(ImmutableList.m428of(element), Ordering.natural());
    }

    /* renamed from: of */
    public static <E extends Comparable<? super E>> ImmutableSortedSet<E> m509of(E e1, E e2) {
        return construct(Ordering.natural(), 2, e1, e2);
    }

    /* renamed from: of */
    public static <E extends Comparable<? super E>> ImmutableSortedSet<E> m510of(E e1, E e2, E e3) {
        return construct(Ordering.natural(), 3, e1, e2, e3);
    }

    /* renamed from: of */
    public static <E extends Comparable<? super E>> ImmutableSortedSet<E> m511of(E e1, E e2, E e3, E e4) {
        return construct(Ordering.natural(), 4, e1, e2, e3, e4);
    }

    /* renamed from: of */
    public static <E extends Comparable<? super E>> ImmutableSortedSet<E> m512of(E e1, E e2, E e3, E e4, E e5) {
        return construct(Ordering.natural(), 5, e1, e2, e3, e4, e5);
    }

    /* renamed from: of */
    public static <E extends Comparable<? super E>> ImmutableSortedSet<E> m513of(E e1, E e2, E e3, E e4, E e5, E e6, E... remaining) {
