...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m446of() {
        return RegularImmutableMap.EMPTY;
    }

    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m447of(K k1, V v1) {
        CollectPreconditions.checkEntryNotNull(k1, v1);
        return RegularImmutableMap.create(1, new Object[]{k1, v1});
    }

    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m448of(K k1, V v1, K k2, V v2) {
        CollectPreconditions.checkEntryNotNull(k1, v1);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m449of(K k1, V v1, K k2, V v2, K k3, V v3) {
        CollectPreconditions.checkEntryNotNull(k1, v1);
        CollectPreconditions.checkEntryNotNull(k2, v2);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m450of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4) {
        CollectPreconditions.checkEntryNotNull(k1, v1);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m451of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5) {
        CollectPreconditions.checkEntryNotNull(k1, v1);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
    ...
    public ImmutableSetMultimap<K, V> asMultimap() {
        if (isEmpty()) {
            return ImmutableSetMultimap.m476of();
        }
    ...
    private final class MapViewOfValuesAsSingletonSets extends IteratorBasedImmutableMap<K, ImmutableSet<V>> {
        ...
        public ImmutableSet<V> get(@NullableDecl Object key) {
            ...
            return ImmutableSet.m470of(outerValue);
        }
                ...
                public Map.Entry<K, ImmutableSet<V>> next() {
                    ...
                    return new AbstractMapEntry<K, ImmutableSet<V>>() {
                        ...
                        public ImmutableSet<V> getValue() {
                            return ImmutableSet.m470of(backingEntry.getValue());
                        }
                    };
                }
            };
