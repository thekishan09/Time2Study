...
final class ConfigurableMutableNetwork<N, E> extends ConfigurableNetwork<N, E> implements MutableNetwork<N, E> {
    ...
    public boolean addEdge(N nodeU, N nodeV, E edge) {
        ...
        if (containsEdge(edge)) {
            ...
            EndpointPair<N> newIncidentNodes = EndpointPair.m527of((Network<?, ?>) this, nodeU, nodeV);
    ...
    private NetworkConnections<N, E> newConnections() {
        if (isDirected()) {
            if (allowsParallelEdges()) {
                return DirectedMultiNetworkConnections.m524of();
            }
            return DirectedNetworkConnections.m525of();
        } else if (allowsParallelEdges()) {
            return UndirectedMultiNetworkConnections.m530of();
        } else {
            return UndirectedNetworkConnections.m531of();
        }
    }
}
