...
public abstract class AbstractNetwork<N, E> implements Network<N, E> {
            ...
            public Set<EndpointPair<N>> edges() {
                ...
                return new AbstractSet<EndpointPair<N>>() {
                    ...
                    public boolean contains(@NullableDecl Object obj) {
                        ...
                        if (!C15331.this.isOrderingCompatible(endpointPair) || !C15331.this.nodes().contains(endpointPair.nodeU()) || !C15331.this.successors((Object) endpointPair.nodeU()).contains(endpointPair.nodeV())) {
                            return false;
                        }
                        return true;
                    }
    ...
    public Set<E> adjacentEdges(E edge) {
        ...
        return Sets.difference(Sets.union(incidentEdges(endpointPair.nodeU()), incidentEdges(endpointPair.nodeV())), ImmutableSet.m470of(edge));
    }
