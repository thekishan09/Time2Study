...
public abstract class EndpointPair<N> implements Iterable<N> {
    ...
    /* renamed from: of */
    static <N> EndpointPair<N> m526of(Graph<?> graph, N nodeU2, N nodeV2) {
        return graph.isDirected() ? ordered(nodeU2, nodeV2) : unordered(nodeU2, nodeV2);
    }

    /* renamed from: of */
    static <N> EndpointPair<N> m527of(Network<?, ?> network, N nodeU2, N nodeV2) {
    ...
    private static final class Ordered<N> extends EndpointPair<N> {
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (isOrdered() == other.isOrdered() && source().equals(other.source()) && target().equals(other.target())) {
                return true;
            }
            return false;
        }
