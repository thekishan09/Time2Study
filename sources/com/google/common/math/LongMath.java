...
public final class LongMath {
    ...
    static final byte[] maxLog10ForLeadingZeros = {19, Ascii.DC2, Ascii.DC2, Ascii.DC2, Ascii.DC2, 17, 17, 17, Ascii.DLE, Ascii.DLE, Ascii.DLE, Ascii.f322SI, Ascii.f322SI, Ascii.f322SI, Ascii.f322SI, Ascii.f323SO, Ascii.f323SO, Ascii.f323SO, Ascii.f313CR, Ascii.f313CR, Ascii.f313CR, Ascii.f315FF, Ascii.f315FF, Ascii.f315FF, Ascii.f315FF, Ascii.f326VT, Ascii.f326VT, Ascii.f326VT, 10, 10, 10, 9, 9, 9, 9, 8, 8, 8, 7, 7, 7, 6, 6, 6, 6, 5, 5, 5, 4, 4, 4, 3, 3, 3, 3, 2, 2, 2, 1, 1, 1, 0, 0, 0};
    ...
    public static int log2(long x, RoundingMode mode) {
        MathPreconditions.checkPositive("x", x);
        switch (C16041.$SwitchMap$java$math$RoundingMode[mode.ordinal()]) {
            case 1:
    ...
    public static long checkedPow(long b, int k) {
        ...
        if ((b >= -2) && (b <= 2)) {
            ...
            if (i == -2) {
                ...
                MathPreconditions.checkNoOverflow(z, "checkedPow", b, (long) k);
                return (k & 1) == 0 ? 1 << k : -1 << k;
            } else if (i != -1) {
                if (i != 0) {
                    if (i == 1) {
