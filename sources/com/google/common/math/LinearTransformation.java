...
public abstract class LinearTransformation {
    ...
    public static final class LinearTransformationBuilder {
        ...
        /* renamed from: x1 */
        private final double f393x1;

        /* renamed from: y1 */
        private final double f394y1;
        ...
        public LinearTransformation and(double x2, double y2) {
            ...
            double d = this.f393x1;
            if (x2 != d) {
                return withSlope((y2 - this.f394y1) / (x2 - d));
            }
            if (y2 == this.f394y1) {
                z = false;
            }
            Preconditions.checkArgument(z);
            return new VerticalLinearTransformation(this.f393x1);
        }
        ...
        public LinearTransformation withSlope(double slope) {
            ...
            if (DoubleUtils.isFinite(slope)) {
                return new RegularLinearTransformation(slope, this.f394y1 - (this.f393x1 * slope));
            }
            return new VerticalLinearTransformation(this.f393x1);
        }
    }
    ...
    private static final class VerticalLinearTransformation extends LinearTransformation {
        ...
        public String toString() {
            return String.format("x = %g", new Object[]{Double.valueOf(this.f395x)});
        }

        private LinearTransformation createInverse() {
            return new RegularLinearTransformation(0.0d, this.f395x, this);
        }
    }
