...
public final class ServiceManager {
    ...
    public ServiceManager(Iterable<? extends Service> services2) {
        ...
        if (copy.isEmpty()) {
            ...
            copy = ImmutableList.m428of(new NoOpService());
        }
    ...
    public ServiceManager startAsync() {
        ...
        while (it2.hasNext()) {
            ...
            try {
                ...
                logger2.log(level, "Unable to start Service " + service2, e);
            }
        }
        return this;
    }
    ...
    private static final class ServiceManagerState {
        ...
        public void awaitHealthy(long timeout, TimeUnit unit) throws TimeoutException {
            ...
            try {
                ...
                throw new TimeoutException("Timeout waiting for the services to become healthy. The following services have not started: " + Multimaps.filterKeys(this.servicesByState, Predicates.m402in(ImmutableSet.m471of(Service.State.NEW, Service.State.STARTING))));
            } finally {
                this.monitor.leave();
            }
        }
        ...
        public void awaitStopped(long timeout, TimeUnit unit) throws TimeoutException {
            ...
            try {
                if (!this.monitor.waitForUninterruptibly(this.stoppedGuard, timeout, unit)) {
                    throw new TimeoutException("Timeout waiting for the services to stop. The following services have not stopped: " + Multimaps.filterKeys(this.servicesByState, Predicates.not(Predicates.m402in(EnumSet.of(Service.State.TERMINATED, Service.State.FAILED)))));
                }
            } finally {
                this.monitor.leave();
            }
        ...
        public void failed(Service.State from, Throwable failure) {
            ...
            if (state2 != null) {
                if (!(this.service instanceof NoOpService)) {
                    ...
                    access$200.log(level, "Service " + this.service + " has failed in the " + from + " state.", failure);
                }
