...
public final class InternetDomainName {
    ...
    private static final Joiner DOT_JOINER = Joiner.m396on('.');
    private static final Splitter DOT_SPLITTER = Splitter.m409on('.');
    private static final int MAX_DOMAIN_PART_LENGTH = 63;
    private static final int MAX_LENGTH = 253;
    private static final int MAX_PARTS = 127;
    private static final int NO_SUFFIX_FOUND = -1;
    private static final CharMatcher PART_CHAR_MATCHER = CharMatcher.javaLetterOrDigit().mo18267or(DASH_MATCHER);
    ...
    InternetDomainName(String name2) {
        ...
        this.registrySuffixIndex = findSuffixOfType(Optional.m398of(PublicSuffixType.REGISTRY));
    }
