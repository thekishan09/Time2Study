...
public final class InetAddresses {
    ...
    private static final Splitter IPV4_SPLITTER = Splitter.m409on('.').limit(4);
    private static final int IPV6_PART_COUNT = 8;
    private static final Splitter IPV6_SPLITTER = Splitter.m409on(':').limit(10);
    ...
    public static TeredoInfo getTeredoInfo(Inet6Address ip) {
        ...
        int port = 65535 & (ByteStreams.newDataInput(bytes, 10).readShort() ^ -1);
