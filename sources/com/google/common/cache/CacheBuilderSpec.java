...
public final class CacheBuilderSpec {
    private static final Splitter KEYS_SPLITTER = Splitter.m409on(',').trimResults();
    private static final Splitter KEY_VALUE_SPLITTER = Splitter.m409on('=').trimResults();
    ...
    public CacheBuilder<Object, Object> toCacheBuilder() {
        ...
        if (this.keyStrength != null) {
            if (C12621.$SwitchMap$com$google$common$cache$LocalCache$Strength[this.keyStrength.ordinal()] == 1) {
                builder.weakKeys();
            } else {
        ...
        if (this.valueStrength != null) {
            int i = C12621.$SwitchMap$com$google$common$cache$LocalCache$Strength[this.valueStrength.ordinal()];
            if (i == 1) {
                builder.weakValues();
            } else if (i == 2) {
                builder.softValues();
