...
abstract class Striped64 extends Number {
    ...
    /* renamed from: fn */
    public abstract long mo18782fn(long j, long j2);
    ...
    static final class Cell {
        ...
        /* renamed from: p0 */
        volatile long f333p0;

        /* renamed from: p1 */
        volatile long f334p1;

        /* renamed from: p2 */
        volatile long f335p2;

        /* renamed from: p3 */
        volatile long f336p3;

        /* renamed from: p4 */
        volatile long f337p4;

        /* renamed from: p5 */
        volatile long f338p5;

        /* renamed from: p6 */
        volatile long f339p6;

        /* renamed from: q0 */
        volatile long f340q0;

        /* renamed from: q1 */
        volatile long f341q1;

        /* renamed from: q2 */
        volatile long f342q2;

        /* renamed from: q3 */
        volatile long f343q3;

        /* renamed from: q4 */
        volatile long f344q4;

        /* renamed from: q5 */
        volatile long f345q5;

        /* renamed from: q6 */
        volatile long f346q6;
        volatile long value;
        ...
        while (true) {
            ...
            if (cellArr != null) {
                ...
                if (length > 0) {
                    ...
                    wasUncontended4 = wasUncontended2;
                    i = 0;
                } else {
            ...
            if (this.busy == 0 && this.cells == as && casBusy()) {
                ...
                long v2 = this.base;
                if (casBase(v2, mo18782fn(v2, j))) {
                    return;
                }
            }
            wasUncontended2 = wasUncontended3;
            wasUncontended4 = wasUncontended2;
            i = 0;
        }
    }
