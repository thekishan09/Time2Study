    ...
    static class StandardBaseEncoding extends BaseEncoding {
        ...
        public void encodeChunkTo(Appendable target, byte[] bytes, int off, int len) throws IOException {
            ...
            while (bitsProcessed < len * 8) {
                target.append(this.alphabet.encode(this.alphabet.mask & ((int) (bitBuffer >>> (bitOffset - bitsProcessed)))));
    ...
    static final class Base64Encoding extends StandardBaseEncoding {
        ...
        public void encodeTo(Appendable target, byte[] bytes, int off, int len) throws IOException {
            ...
            while (remaining >= 3) {
                int i2 = i + 1;
                int i3 = i2 + 1;
                int chunk = ((bytes[i] & UnsignedBytes.MAX_VALUE) << Ascii.DLE) | ((bytes[i2] & UnsignedBytes.MAX_VALUE) << 8) | (bytes[i3] & 255);
        ...
        return new Reader() {
            ...
            public int read() throws java.io.IOException {
                ...
                L_0x0012:
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: com.google.common.p011io.BaseEncoding.C15833.read():int");
            }
