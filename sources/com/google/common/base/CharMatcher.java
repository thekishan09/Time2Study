...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    /* renamed from: is */
    public static CharMatcher m390is(char match) {
        return new C1229Is(match);
    }
    ...
    public static CharMatcher anyOf(CharSequence sequence) {
        ...
        if (length == 1) {
            return m390is(sequence.charAt(0));
        }
        if (length != 2) {
    ...
    /* renamed from: or */
    public CharMatcher mo18267or(CharMatcher other) {
        return new C1230Or(this, other);
    }
    ...
    private static CharMatcher precomputedPositive(int totalCharacters, BitSet table, String description) {
        ...
        if (totalCharacters == 1) {
            return m390is((char) table.nextSetBit(0));
        }
    ...
    private static final class C1230Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C1230Or(CharMatcher a, CharMatcher b) {
            this.first = (CharMatcher) Preconditions.checkNotNull(a);
            this.second = (CharMatcher) Preconditions.checkNotNull(b);
        }
    ...
    private static final class C1229Is extends FastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo18267or(CharMatcher other) {
            return other.matches(this.match) ? other : super.mo18267or(other);
        }
