...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        /* renamed from: f */
        private final Function<A, ? extends B> f327f;

        /* renamed from: g */
        private final Function<B, C> f328g;

        public FunctionComposition(Function<B, C> g, Function<A, ? extends B> f) {
            this.f328g = (Function) Preconditions.checkNotNull(g);
            this.f327f = (Function) Preconditions.checkNotNull(f);
        }

        public C apply(@NullableDecl A a) {
            return this.f328g.apply(this.f327f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f327f.equals(that.f327f) || !this.f328g.equals(that.f328g)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f327f.hashCode() ^ this.f328g.hashCode();
        }

        public String toString() {
            return this.f328g + "(" + this.f327f + ")";
        }
    }
