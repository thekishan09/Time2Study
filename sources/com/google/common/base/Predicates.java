...
public final class Predicates {
    ...
    /* renamed from: or */
    public static <T> Predicate<T> m404or(Iterable<? extends Predicate<? super T>> components) {
        return new OrPredicate(defensiveCopy(components));
    }

    @SafeVarargs
    /* renamed from: or */
    public static <T> Predicate<T> m405or(Predicate<? super T>... components) {
        return new OrPredicate(defensiveCopy((T[]) components));
    }

    /* renamed from: or */
    public static <T> Predicate<T> m403or(Predicate<? super T> first, Predicate<? super T> second) {
    ...
    /* renamed from: in */
    public static <T> Predicate<T> m402in(Collection<? extends T> target) {
    ...
    private static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        /* renamed from: f */
        final Function<A, ? extends B> f329f;

        /* renamed from: p */
        final Predicate<B> f330p;

        private CompositionPredicate(Predicate<B> p, Function<A, ? extends B> f) {
            this.f330p = (Predicate) Preconditions.checkNotNull(p);
            this.f329f = (Function) Preconditions.checkNotNull(f);
        }

        public boolean apply(@NullableDecl A a) {
            return this.f330p.apply(this.f329f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f329f.equals(that.f329f) || !this.f330p.equals(that.f330p)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f329f.hashCode() ^ this.f330p.hashCode();
        }

        public String toString() {
            return this.f330p + "(" + this.f329f + ")";
        }
    }
