...
public enum CaseFormat {
    LOWER_HYPHEN(CharMatcher.m390is('-'), "-") {
    ...
    LOWER_UNDERSCORE(CharMatcher.m390is('_'), "_") {
        /* access modifiers changed from: package-private */
        public String normalizeWord(String word) {
            return Ascii.toLowerCase(word);
        }
    ...
    UPPER_UNDERSCORE(CharMatcher.m390is('_'), "_") {
        /* access modifiers changed from: package-private */
        public String normalizeWord(String word) {
    ...
    /* renamed from: to */
    public final String mo18246to(CaseFormat format, String str) {
    ...
    private static final class StringConverter extends Converter<String, String> implements Serializable {
        ...
        public String doForward(String s) {
            return this.sourceFormat.mo18246to(this.targetFormat, s);
        }

        /* access modifiers changed from: protected */
        public String doBackward(String s) {
            return this.targetFormat.mo18246to(this.sourceFormat, s);
        }
