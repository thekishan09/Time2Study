...
public class ElevationOverlayProvider {
    ...
    public ElevationOverlayProvider(Context context) {
        this.elevationOverlayEnabled = MaterialAttributes.resolveBoolean(context, C0822R.attr.elevationOverlayEnabled, false);
        this.elevationOverlayColor = MaterialColors.getColor(context, C0822R.attr.elevationOverlayColor, 0);
        this.colorSurface = MaterialColors.getColor(context, C0822R.attr.colorSurface, 0);
