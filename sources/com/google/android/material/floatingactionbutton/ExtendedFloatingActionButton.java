...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    private static final int DEF_STYLE_RES = C0822R.style.Widget_MaterialComponents_ExtendedFloatingActionButton_Icon;
    ...
    public ExtendedFloatingActionButton(Context context, AttributeSet attrs) {
        this(context, attrs, C0822R.attr.extendedFloatingActionButtonStyle);
    }
    ...
    public ExtendedFloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0822R.styleable.ExtendedFloatingActionButton, defStyleAttr, DEF_STYLE_RES, new int[0]);
        MotionSpec showMotionSpec = MotionSpec.createFromAttribute(context2, a, C0822R.styleable.ExtendedFloatingActionButton_showMotionSpec);
        MotionSpec hideMotionSpec = MotionSpec.createFromAttribute(context2, a, C0822R.styleable.ExtendedFloatingActionButton_hideMotionSpec);
        MotionSpec extendMotionSpec = MotionSpec.createFromAttribute(context2, a, C0822R.styleable.ExtendedFloatingActionButton_extendMotionSpec);
        MotionSpec shrinkMotionSpec = MotionSpec.createFromAttribute(context2, a, C0822R.styleable.ExtendedFloatingActionButton_shrinkMotionSpec);
    ...
    protected static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        public ExtendedFloatingActionButtonBehavior(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0822R.styleable.ExtendedFloatingActionButton_Behavior_Layout);
            this.autoHideEnabled = a.getBoolean(C0822R.styleable.ExtendedFloatingActionButton_Behavior_Layout_behavior_autoHide, false);
            this.autoShrinkEnabled = a.getBoolean(C0822R.styleable.ExtendedFloatingActionButton_Behavior_Layout_behavior_autoShrink, true);
            a.recycle();
        }
    ...
    class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public int getDefaultMotionSpecResource() {
            return C0822R.animator.mtrl_extended_fab_change_size_motion_spec;
        }
    ...
    class ShowStrategy extends BaseMotionStrategy {
        ...
        public int getDefaultMotionSpecResource() {
            return C0822R.animator.mtrl_extended_fab_show_motion_spec;
        }
    ...
    class HideStrategy extends BaseMotionStrategy {
        ...
        public int getDefaultMotionSpecResource() {
            return C0822R.animator.mtrl_extended_fab_hide_motion_spec;
        }
