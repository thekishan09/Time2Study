...
public class ClockHandView extends View {
    ...
    public ClockHandView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0822R.styleable.ClockHandView, defStyleAttr, 0);
        this.circleRadius = a.getDimensionPixelSize(C0822R.styleable.ClockHandView_materialCircleRadius, 0);
        this.selectorRadius = a.getDimensionPixelSize(C0822R.styleable.ClockHandView_selectorSize, 0);
        Resources res = getResources();
        this.selectorStrokeWidth = res.getDimensionPixelSize(C0822R.dimen.material_clock_hand_stroke_width);
        this.centerDotRadius = (float) res.getDimensionPixelSize(C0822R.dimen.material_clock_hand_center_dot_radius);
        int selectorColor = MaterialColors.getColor(this, C0822R.attr.colorPrimary);
