...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    public TimePickerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.selectionListener = new View.OnClickListener() {
            public void onClick(View v) {
                if (TimePickerView.this.onSelectionChangeListener != null) {
                    TimePickerView.this.onSelectionChangeListener.onSelectionChanged(((Integer) v.getTag(C0822R.C0825id.selection_type)).intValue());
                }
            }
        };
        LayoutInflater.from(context).inflate(C0822R.layout.material_timepicker, this);
        this.clockFace = (ClockFaceView) findViewById(C0822R.C0825id.material_clock_face);
        MaterialButtonToggleGroup materialButtonToggleGroup = (MaterialButtonToggleGroup) findViewById(C0822R.C0825id.material_clock_period_toggle);
        this.toggle = materialButtonToggleGroup;
        materialButtonToggleGroup.addOnButtonCheckedListener(new MaterialButtonToggleGroup.OnButtonCheckedListener() {
            public void onButtonChecked(MaterialButtonToggleGroup group, int checkedId, boolean isChecked) {
                int period = checkedId == C0822R.C0825id.material_clock_period_pm_button ? 1 : 0;
        ...
        this.minuteView = (Chip) findViewById(C0822R.C0825id.material_minute_tv);
        this.hourView = (Chip) findViewById(C0822R.C0825id.material_hour_tv);
    ...
    private void setUpDisplay() {
        this.minuteView.setTag(C0822R.C0825id.selection_type, 12);
        this.hourView.setTag(C0822R.C0825id.selection_type, 10);
    ...
    public void updateTime(int period, int hourOfDay, int minute) {
        this.toggle.check(period == 1 ? C0822R.C0825id.material_clock_period_pm_button : C0822R.C0825id.material_clock_period_am_button);
        Locale current = getResources().getConfiguration().locale;
        String minuteFormatted = String.format(current, "%02d", new Object[]{Integer.valueOf(minute)});
        String hourFormatted = String.format(current, "%02d", new Object[]{Integer.valueOf(hourOfDay)});
    ...
    private void updateToggleConstraints() {
        if (this.toggle.getVisibility() == 0) {
            ...
            constraintSet.clear(C0822R.C0825id.material_clock_display, sideToClear);
