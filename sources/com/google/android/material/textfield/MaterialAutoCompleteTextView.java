...
public class MaterialAutoCompleteTextView extends AppCompatAutoCompleteTextView {
    ...
    public MaterialAutoCompleteTextView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0822R.attr.autoCompleteTextViewStyle);
    }
    ...
    public MaterialAutoCompleteTextView(Context context, AttributeSet attributeSet, int defStyleAttr) {
        ...
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C0822R.styleable.MaterialAutoCompleteTextView, defStyleAttr, C0822R.style.Widget_AppCompat_AutoCompleteTextView, new int[0]);
        if (attributes.hasValue(C0822R.styleable.MaterialAutoCompleteTextView_android_inputType) && attributes.getInt(C0822R.styleable.MaterialAutoCompleteTextView_android_inputType, 0) == 0) {
