...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(C0822R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C0822R.C0824drawable.design_bottom_navigation_item_background);
        this.defaultMargin = res.getDimensionPixelSize(C0822R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C0822R.C0825id.icon);
        this.smallLabel = (TextView) findViewById(C0822R.C0825id.smallLabel);
        this.largeLabel = (TextView) findViewById(C0822R.C0825id.largeLabel);
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        infoCompat.setRoleDescription(getResources().getString(C0822R.string.item_view_role_description));
    }
