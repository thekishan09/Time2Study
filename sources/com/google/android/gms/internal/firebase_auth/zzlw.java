...
interface zzlw {
    ...
    void zza(int i, Object obj, zzkh zzkh) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzkh zzkh) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzkh zzkh) throws IOException;

    void zzb(int i, List<zzgv> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzkh zzkh) throws IOException;
