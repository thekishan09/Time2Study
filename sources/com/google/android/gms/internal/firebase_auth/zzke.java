...
interface zzke {
    ...
    <T> T zza(zzkh<T> zzkh, zzht zzht) throws IOException;

    void zza(List<Double> list) throws IOException;

    <T> void zza(List<T> list, zzkh<T> zzkh, zzht zzht) throws IOException;

    <K, V> void zza(Map<K, V> map, zzji<K, V> zzji, zzht zzht) throws IOException;

    int zzb();

    @Deprecated
    <T> T zzb(zzkh<T> zzkh, zzht zzht) throws IOException;

    void zzb(List<Float> list) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzkh<T> zzkh, zzht zzht) throws IOException;
