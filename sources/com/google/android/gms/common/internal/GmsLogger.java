...
public final class GmsLogger {
    ...
    /* renamed from: d */
    public final void mo11825d(String str, String str2) {
        if (canLog(3)) {
            Log.d(str, zzh(str2));
        }
    }
    ...
    /* renamed from: d */
    public final void mo11826d(String str, String str2, Throwable th) {
        if (canLog(3)) {
    ...
    /* renamed from: v */
    public final void mo11834v(String str, String str2) {
        if (canLog(2)) {
            Log.v(str, zzh(str2));
        }
    }
    ...
    /* renamed from: v */
    public final void mo11835v(String str, String str2, Throwable th) {
        if (canLog(2)) {
    ...
    /* renamed from: i */
    public final void mo11830i(String str, String str2) {
        if (canLog(4)) {
            Log.i(str, zzh(str2));
        }
    }
    ...
    /* renamed from: i */
    public final void mo11831i(String str, String str2, Throwable th) {
        if (canLog(4)) {
    ...
    /* renamed from: w */
    public final void mo11836w(String str, String str2) {
        if (canLog(5)) {
            Log.w(str, zzh(str2));
        }
    }
    ...
    /* renamed from: w */
    public final void mo11837w(String str, String str2, Throwable th) {
        if (canLog(5)) {
    ...
    /* renamed from: e */
    public final void mo11827e(String str, String str2) {
        if (canLog(6)) {
            Log.e(str, zzh(str2));
        }
    }
    ...
    /* renamed from: e */
    public final void mo11828e(String str, String str2, Throwable th) {
        if (canLog(6)) {
