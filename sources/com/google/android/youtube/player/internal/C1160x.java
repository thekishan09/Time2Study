...
public final class C1160x {
    /* renamed from: a */
    public static Map<String, String> m372a(Locale locale) {
        ...
        m373a(hashMap, locale.getLanguage());
        ...
        sb.append("_");
        sb.append(valueOf2);
        m373a(hashMap, sb.toString());
        return hashMap;
    }

    /* renamed from: a */
    private static void m373a(Map<String, String> map, String str) {
        if ("af".equals(str)) {
