...
final class ArrayDecoders {
    ...
    static int decodeVarint32(int firstByte, byte[] data, int position, Registers registers) {
        ...
        if (b3 >= 0) {
            registers.int1 = (b3 << Ascii.f323SO) | value2;
            return position3;
        }
        int value3 = value2 | ((b3 & Ascii.DEL) << Ascii.f323SO);
        ...
        int value4 = value3 | ((position5 & Ascii.DEL) << Ascii.NAK);
        int position6 = position4 + 1;
        byte position7 = data[position4];
        if (position7 >= 0) {
            registers.int1 = (position7 << Ascii.f316FS) | value4;
            return position6;
        }
        int value5 = value4 | ((position7 & Ascii.DEL) << Ascii.f316FS);
        while (true) {
    ...
    static int decodeExtension(int tag, byte[] data, int position, int limit, GeneratedMessageLite.ExtendableMessage<?, ?> message, GeneratedMessageLite.GeneratedExtension<?, ?> extension, UnknownFieldSchema<UnknownFieldSetLite, UnknownFieldSetLite> unknownFieldSchema, Registers registers) throws IOException {
        ...
        if (!generatedExtension.descriptor.isRepeated() || !generatedExtension.descriptor.isPacked()) {
            ...
            if (extension.getLiteType() != WireFormat.FieldType.ENUM) {
                switch (C20901.$SwitchMap$com$google$protobuf$WireFormat$FieldType[extension.getLiteType().ordinal()]) {
                    case 1:
                        int i2 = limit;
            ...
            if (extension.isRepeated()) {
                ...
                int i17 = C20901.$SwitchMap$com$google$protobuf$WireFormat$FieldType[extension.getLiteType().ordinal()];
                if ((i17 == 17 || i17 == 18) && (oldValue = extensions.getField(generatedExtension.descriptor)) != null) {
