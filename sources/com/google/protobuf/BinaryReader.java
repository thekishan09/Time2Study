...
abstract class BinaryReader implements Reader {
    ...
    /* synthetic */ BinaryReader(C20911 x0) {
        this();
    }
    ...
    private static final class SafeHeapReader extends BinaryReader {
        ...
        private Object readField(WireFormat.FieldType fieldType, Class<?> messageType, ExtensionRegistryLite extensionRegistry) throws IOException {
            switch (C20911.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
                case 1:
                    ...
                    if (i6 < 0) {
                        ...
                        if (i7 >= 0) {
                            ...
                            if (i9 < 0) {
                                ...
                                int i10 = y + 1;
                                byte y2 = bArr[y];
                                int x6 = (x5 ^ (y2 << Ascii.f316FS)) ^ 266354560;
                                if (y2 < 0) {
                                    int i11 = i10 + 1;
                                    if (bArr[i10] < 0) {
                                        i10 = i11 + 1;
            ...
            if (i2 != i) {
                ...
                if (i4 >= 0) {
                    ...
                    if (i6 < 0) {
                        ...
                        int i7 = i5 + 1;
                        int i8 = (buffer2[i5] << Ascii.f323SO) ^ y2;
                        int y3 = i8;
                        if (i8 >= 0) {
                            x = (long) (y3 ^ 16256);
                            i5 = i7;
