...
public abstract class CodedInputStream {
    ...
    private static final class UnsafeDirectNioDecoder extends CodedInputStream {
        ...
        private UnsafeDirectNioDecoder(ByteBuffer buffer2, boolean immutable2) {
            ...
            this.limit = addressOffset + ((long) buffer2.limit());
            long position = this.address + ((long) buffer2.position());
            this.pos = position;
            ...
            if (this.limit != tempPos) {
                ...
                if (i >= 0) {
                    ...
                    if (i2 < 0) {
                        ...
                        int i3 = (UnsafeUtil.getByte(tempPos3) << Ascii.f323SO) ^ x2;
                        int x3 = i3;
                        if (i3 >= 0) {
                            y = x3 ^ 16256;
                            tempPos3 = tempPos4;
            ...
            if (this.limit != tempPos) {
                ...
                if (i >= 0) {
                    ...
                    if (i2 < 0) {
                        ...
                        long tempPos4 = tempPos3 + 1;
                        int i3 = (UnsafeUtil.getByte(tempPos3) << Ascii.f323SO) ^ y2;
                        int y3 = i3;
                        if (i3 >= 0) {
                            x = (long) (y3 ^ 16256);
                            tempPos3 = tempPos4;
    ...
    private static final class StreamDecoder extends CodedInputStream {
        ...
        private void skipRawBytesSlowPath(int r10) throws java.io.IOException {
            ...
            L_0x001e:
                ...
                int r0 = r10 - r2
                java.io.InputStream r1 = r9.input     // Catch:{ all -> 0x0061 }
                long r3 = (long) r0     // Catch:{ all -> 0x0061 }
                long r3 = r1.skip(r3)     // Catch:{ all -> 0x0061 }
                r5 = 0
                int r1 = (r3 > r5 ? 1 : (r3 == r5 ? 0 : -1))
                if (r1 < 0) goto L_0x003c
                long r7 = (long) r0     // Catch:{ all -> 0x0061 }
                ...
                goto L_0x006b
            L_0x0039:
                int r1 = (int) r3     // Catch:{ all -> 0x0061 }
                int r2 = r2 + r1
                goto L_0x001e
            L_0x003c:
                ...
                java.io.InputStream r6 = r9.input     // Catch:{ all -> 0x0061 }
                java.lang.Class r6 = r6.getClass()     // Catch:{ all -> 0x0061 }
