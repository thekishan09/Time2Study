...
public abstract class GeneratedMessageLite<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> extends AbstractMessageLite<MessageType, BuilderType> {
    ...
    public static abstract class ExtendableMessage<MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends GeneratedMessageLite<MessageType, BuilderType> implements ExtendableMessageOrBuilder<MessageType, BuilderType> {
        ...
        private boolean parseExtension(CodedInputStream input, ExtensionRegistryLite extensionRegistry, GeneratedExtension<?, ?> extension, int tag, int fieldNumber) throws IOException {
            ...
            if (packed) {
                ...
                int i2 = C21231.$SwitchMap$com$google$protobuf$WireFormat$JavaType[generatedExtension.descriptor.getLiteJavaType().ordinal()];
                if (i2 == 1) {
                    int i3 = fieldNumber;
                    ...
                    Object value3 = generatedExtension.descriptor.getEnumType().findValueByNumber(rawValue);
                    if (value3 == null) {
        ...
        protected class ExtensionWriter {
            ...
            /* synthetic */ ExtensionWriter(ExtendableMessage x0, boolean x1, C21231 x2) {
                this(x1);
            }
        ...
        public ExtendableMessage<MessageType, BuilderType>.ExtensionWriter newExtensionWriter() {
            return new ExtensionWriter(this, false, (C21231) null);
        }

        /* access modifiers changed from: protected */
        public ExtendableMessage<MessageType, BuilderType>.ExtensionWriter newMessageSetExtensionWriter() {
            return new ExtensionWriter(this, true, (C21231) null);
        }
    ...
    protected static final class SerializedForm implements Serializable {
        ...
        /* renamed from: of */
        public static SerializedForm m580of(MessageLite message) {
