    ...
    private static void reflectivePrintWithIndent(MessageLite messageLite, StringBuilder buffer, int indent) {
        ...
        for (String getter : getters) {
            ...
            if (suffix.endsWith(MAP_SUFFIX) && !suffix.equals(MAP_SUFFIX)) {
                String camelCase2 = suffix.substring(i2, 1).toLowerCase() + suffix.substring(1, suffix.length() - MAP_SUFFIX.length());
            ...
            if (nameToMethod.get("set" + suffix) != null) {
                ...
                String camelCase3 = suffix.substring(i2, 1).toLowerCase() + suffix.substring(1);
