...
final class CodedOutputStreamWriter implements Writer {
    ...
    private CodedOutputStreamWriter(CodedOutputStream output2) {
        CodedOutputStream codedOutputStream = (CodedOutputStream) Internal.checkNotNull(output2, "output");
    ...
    private <K, V> void writeDeterministicMap(int fieldNumber, MapEntryLite.Metadata<K, V> metadata, Map<K, V> map) throws IOException {
        switch (C21011.$SwitchMap$com$google$protobuf$WireFormat$FieldType[metadata.keyType.ordinal()]) {
            case 1:
