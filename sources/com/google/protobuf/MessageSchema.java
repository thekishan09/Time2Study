...
final class MessageSchema<T> implements Schema<T> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r10v30, resolved type: java.lang.reflect.Field} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v24, resolved type: java.lang.String} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v27, resolved type: java.lang.reflect.Field} */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:121:0x02a5  */
    ...
    static <T> com.google.protobuf.MessageSchema<T> newSchemaForRawMessageInfo(com.google.protobuf.RawMessageInfo r44, com.google.protobuf.NewInstanceSchema r45, com.google.protobuf.ListFieldSchema r46, com.google.protobuf.UnknownFieldSchema<?, ?> r47, com.google.protobuf.ExtensionSchema<?> r48, com.google.protobuf.MapFieldSchema r49) {
        /*
            com.google.protobuf.ProtoSyntax r0 = r44.getSyntax()
        ...
        L_0x000a:
            r10 = 0
        L_0x000b:
            java.lang.String r0 = r44.getStringInfo()
            int r1 = r0.length()
            r4 = 0
            int r5 = r4 + 1
        ...
        L_0x01bb:
            ...
            java.lang.Object[] r30 = r44.getObjects()
            r5 = 0
            com.google.protobuf.MessageLite r8 = r44.getDefaultInstance()
        ...
        L_0x022b:
            ...
            r11 = r5 & 1024(0x400, float:1.435E-42)
        ...
        L_0x02a9:
            ...
            java.lang.reflect.Field r4 = reflectField(r14, r4)
            r30[r1] = r4
        L_0x02b2:
            r39 = r10
            r19 = r11
            long r10 = r15.objectFieldOffset(r4)
            int r11 = (int) r10
            int r1 = r1 + 1
            r3 = r30[r1]
            boolean r10 = r3 instanceof java.lang.reflect.Field
        ...
        L_0x02c7:
            ...
            java.lang.reflect.Field r10 = reflectField(r14, r10)
            r30[r1] = r10
        L_0x02d0:
            r40 = r3
            r31 = r4
            long r3 = r15.objectFieldOffset(r10)
            int r4 = (int) r3
            r1 = 0
            r40 = r0
            r41 = r2
        ...
        L_0x02ff:
            ...
            if (r9 != r6) goto L_0x0306
            goto L_0x0357
        L_0x0306:
            r10 = 12
            if (r9 == r10) goto L_0x0342
            r10 = 30
            if (r9 == r10) goto L_0x0342
            r10 = 44
        ...
        L_0x0372:
            r10 = r7
            long r6 = r15.objectFieldOffset(r3)
            int r7 = (int) r6
            r6 = r20 & 1
            if (r6 != r11) goto L_0x03dc
            r6 = 17
            if (r9 > r6) goto L_0x03dc
            int r6 = r8 + 1
            char r4 = r0.charAt(r8)
        ...
        L_0x03c4:
            ...
            java.lang.reflect.Field r0 = reflectField(r14, r0)
            r30[r18] = r0
        L_0x03cd:
            r19 = r1
            r41 = r2
            long r1 = r15.objectFieldOffset(r0)
            int r2 = (int) r1
            int r6 = r6 % 32
            r0 = r4
            r1 = r6
        ...
        L_0x040b:
            r6 = 0
        L_0x040c:
            r7 = r5 & 256(0x100, float:3.59E-43)
        ...
        L_0x0432:
            ...
            com.google.protobuf.MessageLite r9 = r44.getDefaultInstance()
            r11 = 0
            int r2 = r28 + r26
            r4 = r1
            r5 = r13
    ...
    static <T> MessageSchema<T> newSchemaForMessageInfo(StructuralMessageInfo messageInfo, NewInstanceSchema newInstanceSchema2, ListFieldSchema listFieldSchema2, UnknownFieldSchema<?, ?> unknownFieldSchema2, ExtensionSchema<?> extensionSchema2, MapFieldSchema mapFieldSchema2) {
        ...
        for (FieldInfo fi : fis) {
            if (fi.getType() == FieldType.MAP) {
                mapFieldCount++;
            } else if (fi.getType().mo29370id() >= 18 && fi.getType().mo29370id() <= 49) {
                repeatedFieldCount++;
            }
        }
        ...
        while (checkInitializedIndex2 < fis.length) {
            ...
            } else if (fi2.getType().mo29370id() < 18 || fi2.getType().mo29370id() > 49) {
                fieldIndex = checkInitializedIndex2;
            } else {
                fieldIndex = checkInitializedIndex2;
        ...
        int fieldIndex2 = checkInitializedIndex2;
        ...
        int[] iArr = repeatedFieldOffsets;
        int i = fieldIndex2;
        int i2 = checkInitializedIndex;
        int[] iArr2 = checkInitialized;
    ...
    private static void storeFieldData(FieldInfo fi, int[] buffer2, int bufferIndex, boolean proto32, Object[] objects2) {
        ...
        if (oneof != null) {
            typeId2 = fi.getType().mo29370id() + 51;
            ...
            int typeId3 = type.mo29370id();
            if (!proto32 && !type.isList() && !type.isMap()) {
                int presenceFieldOffset = (int) UnsafeUtil.objectFieldOffset(fi.getPresenceField());
                presenceMaskShift = Integer.numberOfTrailingZeros(fi.getPresenceMask());
                typeId2 = typeId3;
                typeId = presenceFieldOffset;
        ...
        buffer2[bufferIndex + 2] = (presenceMaskShift << 20) | typeId;
    ...
    private int getSerializedSizeProto2(T message) {
        ...
        while (i < this.buffer.length) {
            ...
            } else if (this.useCachedSizeField && fieldType >= FieldType.DOUBLE_LIST_PACKED.mo29370id() && fieldType <= FieldType.SINT64_LIST_PACKED.mo29370id()) {
    ...
    private int getSerializedSizeProto3(T message) {
        ...
        for (int i = 0; i < this.buffer.length; i += 3) {
            ...
            int number = numberAt(i);
            long offset = offset(typeAndOffset);
            int cachedSizeOffset = (fieldType < FieldType.DOUBLE_LIST_PACKED.mo29370id() || fieldType > FieldType.SINT64_LIST_PACKED.mo29370id()) ? 0 : this.buffer[i + 2] & OFFSET_MASK;
            switch (fieldType) {
                case 0:
    ...
    private int decodeMapEntryValue(byte[] data, int position, int limit, WireFormat.FieldType fieldType, Class<?> messageType, ArrayDecoders.Registers registers) throws IOException {
        switch (C21321.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            case 1:
    ...
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public int parseProto2Message(T r35, byte[] r36, int r37, int r38, int r39, com.google.protobuf.ArrayDecoders.Registers r40) throws java.io.IOException {
        /*
            r34 = this;
            r15 = r34
            r14 = r35
        ...
        L_0x01b4:
            ...
            goto L_0x01fd
        L_0x01de:
            com.google.protobuf.UnknownFieldSetLite r3 = getMutableUnknownFields(r35)
            long r8 = (long) r1
        ...
        L_0x025e:
            ...
            r3 = r13
            r13 = r38
            int r0 = com.google.protobuf.ArrayDecoders.decodeMessageField(r0, r12, r8, r13, r2)
            r1 = r7 & r21
        ...
        L_0x0330:
            r4 = 0
        L_0x0331:
            com.google.protobuf.UnsafeUtil.putBoolean((java.lang.Object) r14, (long) r10, (boolean) r4)
            r7 = r7 | r21
            r0 = r37
            r11 = r39
            r10 = r5
        ...
        L_0x03e1:
            ...
            int r0 = com.google.protobuf.ArrayDecoders.decodeVarint32(r12, r8, r13)
            int r1 = r13.int1
        ...
        L_0x0414:
            ...
            r17 = r2
            if (r9 != 0) goto L_0x04b3
            int r8 = com.google.protobuf.ArrayDecoders.decodeVarint64(r12, r8, r13)
            long r4 = r13.long1
            r0 = r6
            r1 = r35
            r2 = r10
        ...
        L_0x05a3:
            ...
            r0 = 50
            r14 = r37
            if (r14 != r0) goto L_0x05f8
            r15 = r31
            r0 = 2
            if (r15 != r0) goto L_0x05f5
            r9 = r18
            r0 = r34
            r1 = r35
            r2 = r36
        ...
        L_0x0677:
            r12 = r40
        L_0x0679:
            com.google.protobuf.UnknownFieldSetLite r4 = getMutableUnknownFields(r35)
            r0 = r10
            r1 = r36
            r2 = r18
            r3 = r38
    ...
    private int parseProto3Message(T r30, byte[] r31, int r32, int r33, com.google.protobuf.ArrayDecoders.Registers r34) throws java.io.IOException {
        ...
        L_0x0014:
            ...
            int r4 = com.google.protobuf.ArrayDecoders.decodeVarint32(r0, r12, r4, r11)
            int r0 = r11.int1
            r16 = r0
            r10 = r4
            goto L_0x0029
        ...
        L_0x0198:
            r0 = 0
        L_0x0199:
            com.google.protobuf.UnsafeUtil.putBoolean((java.lang.Object) r14, (long) r4, (boolean) r0)
            r0 = r1
            r3 = r6
            r1 = r16
            r2 = r17
        ...
        L_0x036a:
            ...
            r22 = r21
            r0 = 50
            if (r15 != r0) goto L_0x03b3
            r14 = r32
            if (r14 != r1) goto L_0x03ae
            r9 = r23
            r0 = r29
            r1 = r30
            r2 = r31
    ...
    private boolean isFieldPresent(T message, int pos) {
        if (this.proto3) {
            ...
            switch (type(typeAndOffset)) {
                case 0:
                    if (UnsafeUtil.getDouble((Object) message, offset) != 0.0d) {
                        return true;
                    }
                    return false;
                case 1:
                    if (UnsafeUtil.getFloat((Object) message, offset) != 0.0f) {
                        return true;
                    }
                    return false;
                case 2:
            ...
            if ((UnsafeUtil.getInt((Object) message, (long) (OFFSET_MASK & presenceMaskAndOffset)) & (1 << (presenceMaskAndOffset >>> 20))) != 0) {
                return true;
            }
            return false;
        }
    ...
    private boolean isOneofPresent(T message, int fieldNumber, int pos) {
        return UnsafeUtil.getInt((Object) message, (long) (OFFSET_MASK & presenceMaskAndOffsetAt(pos))) == fieldNumber;
    }

    private boolean isOneofCaseEqual(T message, T other, int pos) {
        int presenceMaskAndOffset = presenceMaskAndOffsetAt(pos);
        return UnsafeUtil.getInt((Object) message, (long) (presenceMaskAndOffset & OFFSET_MASK)) == UnsafeUtil.getInt((Object) other, (long) (OFFSET_MASK & presenceMaskAndOffset));
    }

    private void setOneofPresent(T message, int fieldNumber, int pos) {
        UnsafeUtil.putInt((Object) message, (long) (OFFSET_MASK & presenceMaskAndOffsetAt(pos)), fieldNumber);
    }
