...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    private static class ArrayEncoder extends CodedOutputStream {
        ...
        public final void writeUInt32NoTag(int value) throws IOException {
            if (!CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS || Android.isOnAndroidDevice() || spaceLeft() < 5) {
                ...
                this.position = i11 + 1;
                UnsafeUtil.putByte(bArr11, (long) i11, (byte) (value4 >>> 7));
            }
        }
        ...
        public final void writeUInt64NoTag(long value) throws IOException {
            if (!CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS || spaceLeft() < 10) {
                ...
                while ((value & -128) != 0) {
                    ...
                    int i3 = this.position;
                    this.position = i3 + 1;
                    UnsafeUtil.putByte(bArr3, (long) i3, (byte) ((((int) value) & 127) | 128));
                    value >>>= 7;
                }
                byte[] bArr4 = this.buffer;
                int i4 = this.position;
    ...
    private static final class UnsafeDirectNioEncoder extends CodedOutputStream {
        ...
        UnsafeDirectNioEncoder(ByteBuffer buffer2) {
            ...
            this.initialPosition = addressOffset + ((long) buffer2.position());
            long limit2 = this.address + ((long) buffer2.limit());
            this.limit = limit2;
        ...
        public void write(byte[] value, int offset, int length) throws IOException {
            if (value != null && offset >= 0 && length >= 0 && value.length - length >= offset) {
                long j = this.position;
                if (this.limit - ((long) length) >= j) {
                    UnsafeUtil.copyMemory(value, (long) offset, j, (long) length);
        ...
        public final void bufferUInt64NoTag(long value) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while ((value & -128) != 0) {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    UnsafeUtil.putByte(bArr, (long) i, (byte) ((((int) value) & 127) | 128));
                    value >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i2 = this.position;
