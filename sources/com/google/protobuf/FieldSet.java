...
final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    /* synthetic */ FieldSet(SmallSortedMap x0, C21201 x1) {
        this(x0);
    }
    ...
    public static boolean isValidType(WireFormat.FieldType type, Object value) {
        ...
        switch (C21201.$SwitchMap$com$google$protobuf$WireFormat$JavaType[type.getJavaType().ordinal()]) {
            case 1:
    ...
    static void writeElementNoTag(CodedOutputStream output, WireFormat.FieldType type, Object value) throws IOException {
        switch (C21201.$SwitchMap$com$google$protobuf$WireFormat$FieldType[type.ordinal()]) {
            case 1:
    ...
    static final class Builder<T extends FieldDescriptorLite<T>> {
        ...
        public FieldSet<T> build() {
            ...
            FieldSet<T> fieldSet = new FieldSet<>(fieldsForBuild, (C21201) null);
