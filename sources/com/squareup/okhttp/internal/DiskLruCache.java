...
public final class DiskLruCache implements Closeable {
    ...
    public synchronized com.squareup.okhttp.internal.DiskLruCache.Editor edit(java.lang.String r6, long r7) throws java.io.IOException {
        /*
            ...
            long r1 = r0.sequenceNumber     // Catch:{ all -> 0x0068 }
        ...
        L_0x002f:
            ...
            okio.BufferedSink r1 = r1.writeUtf8(r2)     // Catch:{ all -> 0x0068 }
            r2 = 32
            okio.BufferedSink r1 = r1.writeByte(r2)     // Catch:{ all -> 0x0068 }
            okio.BufferedSink r1 = r1.writeUtf8(r6)     // Catch:{ all -> 0x0068 }
            r2 = 10
            r1.writeByte(r2)     // Catch:{ all -> 0x0068 }
            okio.BufferedSink r1 = r5.journalWriter     // Catch:{ all -> 0x0068 }
    ...
    public synchronized void completeEdit(com.squareup.okhttp.internal.DiskLruCache.Editor r11, boolean r12) throws java.io.IOException {
        /*
            r10 = this;
            monitor-enter(r10)
            com.squareup.okhttp.internal.DiskLruCache$Entry r0 = r11.entry     // Catch:{ all -> 0x0119 }
        ...
        L_0x0014:
            ...
            com.squareup.okhttp.internal.io.FileSystem r2 = r10.fileSystem     // Catch:{ all -> 0x0119 }
            java.io.File[] r3 = r0.dirtyFiles     // Catch:{ all -> 0x0119 }
            r3 = r3[r1]     // Catch:{ all -> 0x0119 }
            boolean r2 = r2.exists(r3)     // Catch:{ all -> 0x0119 }
        ...
        L_0x0051:
            ...
            java.io.File[] r2 = r0.dirtyFiles     // Catch:{ all -> 0x0119 }
            r2 = r2[r1]     // Catch:{ all -> 0x0119 }
            if (r12 == 0) goto L_0x008a
            com.squareup.okhttp.internal.io.FileSystem r3 = r10.fileSystem     // Catch:{ all -> 0x0119 }
            boolean r3 = r3.exists(r2)     // Catch:{ all -> 0x0119 }
            if (r3 == 0) goto L_0x008f
            java.io.File[] r3 = r0.cleanFiles     // Catch:{ all -> 0x0119 }
            r3 = r3[r1]     // Catch:{ all -> 0x0119 }
            com.squareup.okhttp.internal.io.FileSystem r4 = r10.fileSystem     // Catch:{ all -> 0x0119 }
            r4.rename(r2, r3)     // Catch:{ all -> 0x0119 }
            long[] r4 = r0.lengths     // Catch:{ all -> 0x0119 }
            r5 = r4[r1]     // Catch:{ all -> 0x0119 }
            r4 = r5
            com.squareup.okhttp.internal.io.FileSystem r6 = r10.fileSystem     // Catch:{ all -> 0x0119 }
            long r6 = r6.size(r3)     // Catch:{ all -> 0x0119 }
        ...
        L_0x0092:
            ...
            r1 = 0
            com.squareup.okhttp.internal.DiskLruCache.Editor unused = r0.currentEditor = r1     // Catch:{ all -> 0x0119 }
            boolean r1 = r0.readable     // Catch:{ all -> 0x0119 }
            r1 = r1 | r12
            r3 = 10
            r4 = 32
            ...
            okio.BufferedSink r1 = r10.journalWriter     // Catch:{ all -> 0x0119 }
            java.lang.String r2 = "CLEAN"
            okio.BufferedSink r1 = r1.writeUtf8(r2)     // Catch:{ all -> 0x0119 }
            r1.writeByte(r4)     // Catch:{ all -> 0x0119 }
            okio.BufferedSink r1 = r10.journalWriter     // Catch:{ all -> 0x0119 }
            java.lang.String r2 = r0.key     // Catch:{ all -> 0x0119 }
            r1.writeUtf8(r2)     // Catch:{ all -> 0x0119 }
            okio.BufferedSink r1 = r10.journalWriter     // Catch:{ all -> 0x0119 }
            r0.writeLengths(r1)     // Catch:{ all -> 0x0119 }
            okio.BufferedSink r1 = r10.journalWriter     // Catch:{ all -> 0x0119 }
            ...
            goto L_0x00f7
        L_0x00d5:
            java.util.LinkedHashMap<java.lang.String, com.squareup.okhttp.internal.DiskLruCache$Entry> r1 = r10.lruEntries     // Catch:{ all -> 0x0119 }
            java.lang.String r2 = r0.key     // Catch:{ all -> 0x0119 }
        ...
        L_0x010a:
            java.util.concurrent.Executor r1 = r10.executor     // Catch:{ all -> 0x0119 }
            java.lang.Runnable r2 = r10.cleanupRunnable     // Catch:{ all -> 0x0119 }
