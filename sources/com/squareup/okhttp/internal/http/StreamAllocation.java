...
public final class StreamAllocation {
    ...
    private com.squareup.okhttp.internal.p013io.RealConnection findHealthyConnection(int r4, int r5, int r6, boolean r7, boolean r8) throws java.io.IOException, com.squareup.okhttp.internal.http.RouteException {
        /*
            r3 = this;
        L_0x0000:
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x003b, code lost:
        r8 = new com.squareup.okhttp.internal.p013io.RealConnection(r9.routeSelector.next());
        acquire(r8);
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private com.squareup.okhttp.internal.p013io.RealConnection findConnection(int r10, int r11, int r12, boolean r13) throws java.io.IOException, com.squareup.okhttp.internal.http.RouteException {
        /*
            r9 = this;
            com.squareup.okhttp.ConnectionPool r0 = r9.connectionPool
            monitor-enter(r0)
            boolean r1 = r9.released     // Catch:{ all -> 0x0098 }
            if (r1 != 0) goto L_0x0090
            com.squareup.okhttp.internal.http.HttpStream r1 = r9.stream     // Catch:{ all -> 0x0098 }
            if (r1 != 0) goto L_0x0088
            boolean r1 = r9.canceled     // Catch:{ all -> 0x0098 }
            if (r1 != 0) goto L_0x0080
            com.squareup.okhttp.internal.io.RealConnection r1 = r9.connection     // Catch:{ all -> 0x0098 }
            if (r1 == 0) goto L_0x0019
            boolean r2 = r1.noNewStreams     // Catch:{ all -> 0x0098 }
            if (r2 != 0) goto L_0x0019
            monitor-exit(r0)     // Catch:{ all -> 0x0098 }
            return r1
        L_0x0019:
            com.squareup.okhttp.internal.Internal r2 = com.squareup.okhttp.internal.Internal.instance     // Catch:{ all -> 0x0098 }
            com.squareup.okhttp.ConnectionPool r3 = r9.connectionPool     // Catch:{ all -> 0x0098 }
            com.squareup.okhttp.Address r4 = r9.address     // Catch:{ all -> 0x0098 }
            com.squareup.okhttp.internal.io.RealConnection r2 = r2.get(r3, r4, r9)     // Catch:{ all -> 0x0098 }
            if (r2 == 0) goto L_0x0029
            r9.connection = r2     // Catch:{ all -> 0x0098 }
            monitor-exit(r0)     // Catch:{ all -> 0x0098 }
            return r2
        L_0x0029:
            com.squareup.okhttp.internal.http.RouteSelector r3 = r9.routeSelector     // Catch:{ all -> 0x0098 }
            if (r3 != 0) goto L_0x003a
            com.squareup.okhttp.internal.http.RouteSelector r3 = new com.squareup.okhttp.internal.http.RouteSelector     // Catch:{ all -> 0x0098 }
            com.squareup.okhttp.Address r4 = r9.address     // Catch:{ all -> 0x0098 }
            com.squareup.okhttp.internal.RouteDatabase r5 = r9.routeDatabase()     // Catch:{ all -> 0x0098 }
            r3.<init>(r4, r5)     // Catch:{ all -> 0x0098 }
            r9.routeSelector = r3     // Catch:{ all -> 0x0098 }
        L_0x003a:
            monitor-exit(r0)     // Catch:{ all -> 0x0098 }
        ...
        L_0x007d:
            ...
            throw r0
        L_0x0080:
            java.io.IOException r1 = new java.io.IOException     // Catch:{ all -> 0x0098 }
            java.lang.String r2 = "Canceled"
            r1.<init>(r2)     // Catch:{ all -> 0x0098 }
            throw r1     // Catch:{ all -> 0x0098 }
        L_0x0088:
            java.lang.IllegalStateException r1 = new java.lang.IllegalStateException     // Catch:{ all -> 0x0098 }
