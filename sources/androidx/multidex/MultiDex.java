...
public final class MultiDex {
    ...
    private static void doInstallation(android.content.Context r9, java.io.File r10, java.io.File r11, java.lang.String r12, java.lang.String r13, boolean r14) throws java.io.IOException, java.lang.IllegalArgumentException, java.lang.IllegalAccessException, java.lang.NoSuchFieldException, java.lang.reflect.InvocationTargetException, java.lang.NoSuchMethodException, java.lang.SecurityException, java.lang.ClassNotFoundException, java.lang.InstantiationException {
        /*
            ...
            monitor-enter(r0)
            java.util.Set<java.io.File> r1 = installedApk     // Catch:{ all -> 0x00b9 }
            boolean r1 = r1.contains(r10)     // Catch:{ all -> 0x00b9 }
            if (r1 == 0) goto L_0x000d
            monitor-exit(r0)     // Catch:{ all -> 0x00b9 }
            return
        L_0x000d:
            java.util.Set<java.io.File> r1 = installedApk     // Catch:{ all -> 0x00b9 }
            r1.add(r10)     // Catch:{ all -> 0x00b9 }
            ...
            int r4 = android.os.Build.VERSION.SDK_INT     // Catch:{ all -> 0x00b9 }
            r3.append(r4)     // Catch:{ all -> 0x00b9 }
            ...
            java.lang.String r2 = java.lang.System.getProperty(r2)     // Catch:{ all -> 0x00b9 }
            r3.append(r2)     // Catch:{ all -> 0x00b9 }
            java.lang.String r2 = "\""
            r3.append(r2)     // Catch:{ all -> 0x00b9 }
            java.lang.String r2 = r3.toString()     // Catch:{ all -> 0x00b9 }
            android.util.Log.w(r1, r2)     // Catch:{ all -> 0x00b9 }
        L_0x0055:
            java.lang.ClassLoader r1 = r9.getClassLoader()     // Catch:{ RuntimeException -> 0x00af }
            ...
            android.util.Log.e(r2, r3)     // Catch:{ all -> 0x00b9 }
            monitor-exit(r0)     // Catch:{ all -> 0x00b9 }
            return
        L_0x0065:
            clearOldDexDir(r9)     // Catch:{ all -> 0x0069 }
            goto L_0x0071
        L_0x0069:
            r2 = move-exception
            ...
            android.util.Log.w(r3, r4, r2)     // Catch:{ all -> 0x00b9 }
        L_0x0071:
            java.io.File r2 = getDexDir(r9, r11, r12)     // Catch:{ all -> 0x00b9 }
            androidx.multidex.MultiDexExtractor r3 = new androidx.multidex.MultiDexExtractor     // Catch:{ all -> 0x00b9 }
            r3.<init>(r10, r2)     // Catch:{ all -> 0x00b9 }
            r4 = 0
            r5 = 0
            java.util.List r5 = r3.load(r9, r13, r5)     // Catch:{ all -> 0x00a6 }
            installSecondaryDexes(r1, r2, r5)     // Catch:{ IOException -> 0x0084 }
            goto L_0x0097
        L_0x0084:
            r6 = move-exception
            ...
            android.util.Log.w(r7, r8, r6)     // Catch:{ all -> 0x00a6 }
            r7 = 1
            java.util.List r7 = r3.load(r9, r13, r7)     // Catch:{ all -> 0x00a6 }
            r5 = r7
            installSecondaryDexes(r1, r2, r5)     // Catch:{ all -> 0x00a6 }
        L_0x0097:
        ...
        L_0x00af:
            ...
            android.util.Log.w(r2, r3, r1)     // Catch:{ all -> 0x00b9 }
            monitor-exit(r0)     // Catch:{ all -> 0x00b9 }
            return
        L_0x00b9:
            r1 = move-exception
    ...
    private static final class C0001V4 {
        private C0001V4() {
        }
