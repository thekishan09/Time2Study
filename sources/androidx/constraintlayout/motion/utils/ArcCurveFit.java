    ...
    private static class Arc {
        ...
        Arc(int mode, double t1, double t2, double x1, double y1, double x2, double y2) {
            ...
            if (this.linear || Math.abs(dx2) < EPSILON) {
                ...
                double d10 = (double) (this.mVertical ? -1 : 1);
                Double.isNaN(d10);
                this.mEllipseA = d10 * dx2;
                double d11 = (double) (!this.mVertical ? -1 : i2);
                Double.isNaN(d11);
                this.mEllipseB = d11 * dy2;
                this.mEllipseCenterX = this.mVertical ? d8 : d6;
                this.mEllipseCenterY = this.mVertical ? d7 : y2;
                double d12 = dx2;
                double d13 = y2;
                double d14 = dy2;
                double d15 = d8;
