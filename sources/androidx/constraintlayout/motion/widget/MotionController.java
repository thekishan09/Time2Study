...
public class MotionController {
    ...
    public KeyPositionBase getPositionKeyframe(int layoutWidth, int layoutHeight, float x, float y) {
        ...
        start.left = this.mStartMotionPath.f30x;
        start.top = this.mStartMotionPath.f31y;
        start.right = start.left + this.mStartMotionPath.width;
        start.bottom = start.top + this.mStartMotionPath.height;
        RectF end = new RectF();
        end.left = this.mEndMotionPath.f30x;
        end.top = this.mEndMotionPath.f31y;
    ...
    public float getKeyFrameParameter(int type, float x, float y) {
        float dx = this.mEndMotionPath.f30x - this.mStartMotionPath.f30x;
        float dy = this.mEndMotionPath.f31y - this.mStartMotionPath.f31y;
        float startCenterX = this.mStartMotionPath.f30x + (this.mStartMotionPath.width / 2.0f);
        float startCenterY = this.mStartMotionPath.f31y + (this.mStartMotionPath.height / 2.0f);
    ...
    public boolean interpolate(View child, float global_position, long time, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float float_l = this.mStartMotionPath.f30x + ((this.mEndMotionPath.f30x - this.mStartMotionPath.f30x) * position);
            float float_t = this.mStartMotionPath.f31y + ((this.mEndMotionPath.f31y - this.mStartMotionPath.f31y) * position);
    ...
    public void getDpDt(float position, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        float dleft = this.mEndMotionPath.f30x - this.mStartMotionPath.f30x;
        float dTop = this.mEndMotionPath.f31y - this.mStartMotionPath.f31y;
