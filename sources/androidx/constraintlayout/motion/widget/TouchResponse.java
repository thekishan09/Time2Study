...
class TouchResponse {
    ...
    private void fillFromAttributeList(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, C0216R.styleable.OnSwipe);
        fill(a);
        a.recycle();
    }
    ...
    private void fill(TypedArray a) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            if (attr == C0216R.styleable.OnSwipe_touchAnchorId) {
                this.mTouchAnchorId = a.getResourceId(attr, this.mTouchAnchorId);
            } else if (attr == C0216R.styleable.OnSwipe_touchAnchorSide) {
    ...
    public void processTouchEvent(MotionEvent event, MotionLayout.MotionTracker velocityTracker, int currentState, MotionScene motionScene) {
        ...
        if (action != 0) {
            ...
            if (action == 1) {
                ...
                float f2 = (fArr2[0] * minSize2) + (this.mTouchDirectionY * fArr2[1]);
                if (minSize2 != 0.0f) {
                ...
                if (Math.abs((this.mTouchDirectionX * dx) + (this.mTouchDirectionY * dy)) > 10.0f || this.mDragStarted) {
