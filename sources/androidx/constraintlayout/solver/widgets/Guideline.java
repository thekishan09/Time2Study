...
public class Guideline extends ConstraintWidget {
    ...
    static /* synthetic */ class C02061 {
        ...
        static {
            ...
            try {
                f40x4c44d048[ConstraintAnchor.Type.RIGHT.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f40x4c44d048[ConstraintAnchor.Type.TOP.ordinal()] = 3;
    ...
    public ConstraintAnchor getAnchor(ConstraintAnchor.Type anchorType) {
        switch (C02061.f40x4c44d048[anchorType.ordinal()]) {
            case 1:
            case 2:
                if (this.mOrientation == 1) {
                    return this.mAnchor;
    ...
    public void addToSolver(LinearSystem system) {
        ...
        if (parent != null) {
            ...
            if (this.mRelativeBegin != -1) {
                ...
                system.addEquality(guide, system.createObjectVariable(begin), this.mRelativeBegin, 7);
                ...
                system.addEquality(guide2, parentRight, -this.mRelativeEnd, 7);
                if (parentWrapContent) {
