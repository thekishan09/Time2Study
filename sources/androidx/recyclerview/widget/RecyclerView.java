...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public RecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context2.obtainStyledAttributes(attributeSet, C0438R.styleable.RecyclerView, i, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C0438R.styleable.RecyclerView, attrs, a, defStyleAttr, 0);
        ...
        boolean z = a.getBoolean(C0438R.styleable.RecyclerView_fastScrollEnabled, false);
        this.mEnableFastScroller = z;
        if (z) {
            initFastScroller((StateListDrawable) a.getDrawable(C0438R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a.getDrawable(C0438R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a.getDrawable(C0438R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a.getDrawable(C0438R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
        }
        a.recycle();
    ...
    public Rect getItemDecorInsetsForChild(View child) {
        ...
        boolean positionWillChange = lp.mViewHolder.getLayoutPosition() != lp.mViewHolder.getAbsoluteAdapterPosition();
        if (this.mState.isPreLayout() && (lp.isItemChanged() || lp.isViewInvalid() || positionWillChange)) {
            return lp.mDecorInsets;
        }
        Rect insets = lp.mDecorInsets;
        insets.set(0, 0, 0, 0);
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public boolean canRestoreState() {
            int i = C04837.f66x3d106619[this.mStateRestorationPolicy.ordinal()];
            if (i == 1) {
                return false;
            }
    ...
    static /* synthetic */ class C04837 {
        ...
        static {
            ...
            try {
                f66x3d106619[Adapter.StateRestorationPolicy.PREVENT_WHEN_EMPTY.ordinal()] = 2;
