...
class ConcatAdapterController implements NestedAdapterWrapper.Callback {
    ...
    public void onViewRecycled(RecyclerView.ViewHolder holder) {
        NestedAdapterWrapper wrapper = this.mBinderLookup.remove(holder);
        if (wrapper != null) {
    ...
    public int getLocalAdapterPosition(RecyclerView.Adapter<? extends RecyclerView.ViewHolder> adapter, RecyclerView.ViewHolder viewHolder, int globalPosition) {
        ...
        throw new IllegalStateException("Detected inconsistent adapter updates. The local position of the view holder maps to " + localPosition + " which is out of bounds for the adapter with size " + wrapper.getCachedItemCount() + ".Make sure to immediately call notify methods in your adapter when you change the backing dataviewHolder:" + viewHolder + "adapter:" + adapter);
    }
