...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    private android.view.ViewGroup createSubDecor() {
        /*
            ...
            int[] r1 = androidx.appcompat.C0063R.styleable.AppCompatTheme
            android.content.res.TypedArray r0 = r0.obtainStyledAttributes(r1)
            int r1 = androidx.appcompat.C0063R.styleable.AppCompatTheme_windowActionBar
            boolean r1 = r0.hasValue(r1)
            if (r1 == 0) goto L_0x01a6
            int r1 = androidx.appcompat.C0063R.styleable.AppCompatTheme_windowNoTitle
            r2 = 0
        ...
        L_0x002b:
            int r1 = androidx.appcompat.C0063R.styleable.AppCompatTheme_windowActionBarOverlay
            boolean r1 = r0.getBoolean(r1, r2)
            r4 = 109(0x6d, float:1.53E-43)
            if (r1 == 0) goto L_0x0038
            r10.requestWindowFeature(r4)
        L_0x0038:
            int r1 = androidx.appcompat.C0063R.styleable.AppCompatTheme_windowActionModeOverlay
            boolean r1 = r0.getBoolean(r1, r2)
            if (r1 == 0) goto L_0x0045
            r1 = 10
            r10.requestWindowFeature(r1)
        L_0x0045:
            int r1 = androidx.appcompat.C0063R.styleable.AppCompatTheme_android_windowIsFloating
            boolean r1 = r0.getBoolean(r1, r2)
            r10.mIsFloating = r1
            r0.recycle()
            r10.ensureWindow()
            ...
            int r3 = androidx.appcompat.C0063R.layout.abc_dialog_title_material
        ...
        L_0x0077:
            ...
            int r9 = androidx.appcompat.C0063R.attr.actionBarTheme
        ...
        L_0x009b:
            ...
            int r9 = androidx.appcompat.C0063R.layout.abc_screen_toolbar
            android.view.View r8 = r8.inflate(r9, r7)
            r5 = r8
            android.view.ViewGroup r5 = (android.view.ViewGroup) r5
            int r8 = androidx.appcompat.C0063R.C0066id.decor_content_parent
        ...
        L_0x00d7:
            ...
            int r3 = androidx.appcompat.C0063R.layout.abc_screen_simple_overlay_action_mode
            android.view.View r3 = r1.inflate(r3, r7)
            android.view.ViewGroup r3 = (android.view.ViewGroup) r3
            r5 = r3
            goto L_0x00ee
        L_0x00e5:
            int r3 = androidx.appcompat.C0063R.layout.abc_screen_simple
            android.view.View r3 = r1.inflate(r3, r7)
            android.view.ViewGroup r3 = (android.view.ViewGroup) r3
            r5 = r3
        L_0x00ee:
        ...
        L_0x0108:
            ...
            int r3 = androidx.appcompat.C0063R.C0066id.title
            android.view.View r3 = r5.findViewById(r3)
            android.widget.TextView r3 = (android.widget.TextView) r3
            r10.mTitleView = r3
        L_0x0118:
            androidx.appcompat.widget.ViewUtils.makeOptionalFitsSystemWindows(r5)
            int r3 = androidx.appcompat.C0063R.C0066id.action_bar_activity_content
            android.view.View r3 = r5.findViewById(r3)
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(C0063R.styleable.AppCompatTheme);
        a.getValue(C0063R.styleable.AppCompatTheme_windowMinWidthMajor, cfl.getMinWidthMajor());
        a.getValue(C0063R.styleable.AppCompatTheme_windowMinWidthMinor, cfl.getMinWidthMinor());
        if (a.hasValue(C0063R.styleable.AppCompatTheme_windowFixedWidthMajor)) {
            a.getValue(C0063R.styleable.AppCompatTheme_windowFixedWidthMajor, cfl.getFixedWidthMajor());
        }
        if (a.hasValue(C0063R.styleable.AppCompatTheme_windowFixedWidthMinor)) {
            a.getValue(C0063R.styleable.AppCompatTheme_windowFixedWidthMinor, cfl.getFixedWidthMinor());
        }
        if (a.hasValue(C0063R.styleable.AppCompatTheme_windowFixedHeightMajor)) {
            a.getValue(C0063R.styleable.AppCompatTheme_windowFixedHeightMajor, cfl.getFixedHeightMajor());
        }
        if (a.hasValue(C0063R.styleable.AppCompatTheme_windowFixedHeightMinor)) {
            a.getValue(C0063R.styleable.AppCompatTheme_windowFixedHeightMinor, cfl.getFixedHeightMinor());
        }
        a.recycle();
        cfl.requestLayout();
    }
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    baseTheme.resolveAttribute(C0063R.attr.actionBarTheme, outValue, true);
                    ...
                    PopupWindow popupWindow = new PopupWindow(actionBarContext, (AttributeSet) null, C0063R.attr.actionModePopupWindowStyle);
                    this.mActionModePopup = popupWindow;
                    PopupWindowCompat.setWindowLayoutType(popupWindow, 2);
                    this.mActionModePopup.setContentView(this.mActionModeView);
                    this.mActionModePopup.setWidth(-1);
                    actionBarContext.getTheme().resolveAttribute(C0063R.attr.actionBarSize, outValue, true);
                    ...
                    ViewStubCompat stub = (ViewStubCompat) this.mSubDecor.findViewById(C0063R.C0066id.action_mode_bar_stub);
                    if (stub != null) {
    ...
    public View createView(View parent, String name, Context context, AttributeSet attrs) {
        ...
        if (this.mAppCompatViewInflater == null) {
            String viewInflaterClassName = this.mContext.obtainStyledAttributes(C0063R.styleable.AppCompatTheme).getString(C0063R.styleable.AppCompatTheme_viewInflaterClass);
        ...
        if (!panelFeatureState.isOpen && !this.mIsDestroyed) {
            ...
            if (cb == null || cb.onMenuOpened(panelFeatureState.featureId, panelFeatureState.menu)) {
                ...
                if (wm != null && preparePanel(st, event)) {
                    ...
                    WindowManager.LayoutParams layoutParams = new WindowManager.LayoutParams(width, -2, panelFeatureState.f8x, panelFeatureState.f9y, 1002, 8519680, -3);
    ...
    private boolean initializePanelMenu(PanelFeatureState st) {
        ...
        if ((st.featureId == 0 || st.featureId == 108) && this.mDecorContentParent != null) {
            ...
            if (outValue.resourceId != 0) {
                ...
                widgetTheme.resolveAttribute(C0063R.attr.actionBarWidgetTheme, outValue, true);
            } else {
                baseTheme.resolveAttribute(C0063R.attr.actionBarWidgetTheme, outValue, true);
            }
            if (outValue.resourceId != 0) {
                if (widgetTheme == null) {
                    widgetTheme = context.getResources().newTheme();
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (mlp.topMargin != (localInsets.top == 0 ? insetTop : 0)) {
                    ...
                    if (view == null) {
                        ...
                        view2.setBackgroundColor(this.mContext.getResources().getColor(C0063R.C0064color.abc_input_method_navigation_guard));
    ...
    protected static final class PanelFeatureState {
        ...
        public void setStyle(Context context) {
            ...
            widgetTheme.resolveAttribute(C0063R.attr.actionBarPopupTheme, outValue, true);
            if (outValue.resourceId != 0) {
                widgetTheme.applyStyle(outValue.resourceId, true);
            }
            widgetTheme.resolveAttribute(C0063R.attr.panelMenuListTheme, outValue, true);
            if (outValue.resourceId != 0) {
                widgetTheme.applyStyle(outValue.resourceId, true);
            } else {
                widgetTheme.applyStyle(C0063R.style.Theme_AppCompat_CompactMenu, true);
            }
            Context context2 = new ContextThemeWrapper(context, 0);
            context2.getTheme().setTo(widgetTheme);
            this.listPresenterContext = context2;
            TypedArray a = context2.obtainStyledAttributes(C0063R.styleable.AppCompatTheme);
            this.background = a.getResourceId(C0063R.styleable.AppCompatTheme_panelBackground, 0);
            this.windowAnimations = a.getResourceId(C0063R.styleable.AppCompatTheme_android_windowAnimationStyle, 0);
            a.recycle();
        }
        ...
        public MenuView getListMenuView(MenuPresenter.Callback cb) {
            ...
            if (this.listMenuPresenter == null) {
                ListMenuPresenter listMenuPresenter2 = new ListMenuPresenter(this.listPresenterContext, C0063R.layout.abc_list_menu_item_layout);
    ...
    private class ActionBarDrawableToggleImpl implements ActionBarDrawerToggle.Delegate {
        ...
        public Drawable getThemeUpIndicator() {
            TintTypedArray a = TintTypedArray.obtainStyledAttributes(getActionBarThemedContext(), (AttributeSet) null, new int[]{C0063R.attr.homeAsUpIndicator});
