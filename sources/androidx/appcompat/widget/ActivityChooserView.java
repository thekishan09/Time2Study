...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray attributesArray = context.obtainStyledAttributes(attrs, C0063R.styleable.ActivityChooserView, defStyle, 0);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0063R.styleable.ActivityChooserView, attrs, attributesArray, defStyle, 0);
        }
        this.mInitialActivityCount = attributesArray.getInt(C0063R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable expandActivityOverflowButtonDrawable = attributesArray.getDrawable(C0063R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        attributesArray.recycle();
        LayoutInflater.from(getContext()).inflate(C0063R.layout.abc_activity_chooser_view, this, true);
        this.mCallbacks = new Callbacks();
        View findViewById = findViewById(C0063R.C0066id.activity_chooser_view_content);
        this.mActivityChooserContent = findViewById;
        this.mActivityChooserContentBackground = findViewById.getBackground();
        FrameLayout frameLayout = (FrameLayout) findViewById(C0063R.C0066id.default_activity_button);
        this.mDefaultActivityButton = frameLayout;
        frameLayout.setOnClickListener(this.mCallbacks);
        this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
        this.mDefaultActivityButtonImage = (ImageView) this.mDefaultActivityButton.findViewById(C0063R.C0066id.image);
        FrameLayout expandButton = (FrameLayout) findViewById(C0063R.C0066id.expand_activities_button);
        ...
        ImageView imageView = (ImageView) expandButton.findViewById(C0063R.C0066id.image);
        ...
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0063R.dimen.abc_config_prefDialogWidth));
    }
    ...
    public void showPopupUnchecked(int maxActivityCount) {
        if (this.mAdapter.getDataModel() != null) {
            ...
            if (!popupWindow.isShowing()) {
                ...
                popupWindow.getListView().setContentDescription(getContext().getString(C0063R.string.abc_activitychooserview_choose_application));
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            int itemViewType = getItemViewType(position);
            if (itemViewType == 0) {
                if (convertView == null || convertView.getId() != C0063R.C0066id.list_item) {
                    convertView = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0063R.layout.abc_activity_chooser_view_list_item, parent, false);
                }
                PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
                ResolveInfo activity = (ResolveInfo) getItem(position);
                ((ImageView) convertView.findViewById(C0063R.C0066id.icon)).setImageDrawable(activity.loadIcon(packageManager));
                ((TextView) convertView.findViewById(C0063R.C0066id.title)).setText(activity.loadLabel(packageManager));
                ...
                View convertView2 = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0063R.layout.abc_activity_chooser_view_list_item, parent, false);
                convertView2.setId(1);
                ((TextView) convertView2.findViewById(C0063R.C0066id.title)).setText(ActivityChooserView.this.getContext().getString(C0063R.string.abc_activity_chooser_view_see_all));
                return convertView2;
            }
        }
