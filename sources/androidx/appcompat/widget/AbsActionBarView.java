...
abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!context.getTheme().resolveAttribute(C0063R.attr.actionBarPopupTheme, tv, true) || tv.resourceId == 0) {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes((AttributeSet) null, C0063R.styleable.ActionBar, C0063R.attr.actionBarStyle, 0);
        setContentHeight(a.getLayoutDimension(C0063R.styleable.ActionBar_height, 0));
        a.recycle();
