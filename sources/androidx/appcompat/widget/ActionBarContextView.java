...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(Context context, AttributeSet attrs) {
        this(context, attrs, C0063R.attr.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0063R.styleable.ActionMode, defStyle, 0);
        ViewCompat.setBackground(this, a.getDrawable(C0063R.styleable.ActionMode_background));
        this.mTitleStyleRes = a.getResourceId(C0063R.styleable.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = a.getResourceId(C0063R.styleable.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = a.getLayoutDimension(C0063R.styleable.ActionMode_height, 0);
        this.mCloseItemLayout = a.getResourceId(C0063R.styleable.ActionMode_closeItemLayout, C0063R.layout.abc_action_mode_close_item_material);
        a.recycle();
    }
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(C0063R.layout.abc_action_bar_title_item, this);
            LinearLayout linearLayout = (LinearLayout) getChildAt(getChildCount() - 1);
            this.mTitleLayout = linearLayout;
            this.mTitleView = (TextView) linearLayout.findViewById(C0063R.C0066id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0063R.C0066id.action_bar_subtitle);
    ...
    public void initForMode(final ActionMode mode) {
        ...
        this.mClose.findViewById(C0063R.C0066id.action_mode_close_button).setOnClickListener(new View.OnClickListener() {
