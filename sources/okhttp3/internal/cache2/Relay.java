    ...
    class RelaySource implements Source {
        ...
        public long read(okio.Buffer r22, long r23) throws java.io.IOException {
            ...
            L_0x0020:
                ...
                okio.Timeout r0 = r1.timeout     // Catch:{ all -> 0x014f }
            ...
            L_0x003a:
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x014f }
                okio.Buffer r0 = r0.buffer     // Catch:{ all -> 0x014f }
            ...
            L_0x0131:
                ...
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x014f }
                okio.Buffer r11 = r0.buffer     // Catch:{ all -> 0x014f }
                long r12 = r1.sourcePos     // Catch:{ all -> 0x014f }
                long r14 = r12 - r5
                r12 = r22
                r13 = r14
                r15 = r7
                r11.copyTo((okio.Buffer) r12, (long) r13, (long) r15)     // Catch:{ all -> 0x014f }
