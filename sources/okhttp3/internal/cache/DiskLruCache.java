...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    public synchronized void completeEdit(okhttp3.internal.cache.DiskLruCache.Editor r11, boolean r12) throws java.io.IOException {
        ...
        L_0x000e:
            ...
            boolean[] r2 = r11.written     // Catch:{ all -> 0x00fc }
            boolean r2 = r2[r1]     // Catch:{ all -> 0x00fc }
            if (r2 == 0) goto L_0x002c
            okhttp3.internal.io.FileSystem r2 = r10.fileSystem     // Catch:{ all -> 0x00fc }
            java.io.File[] r3 = r0.dirtyFiles     // Catch:{ all -> 0x00fc }
            r3 = r3[r1]     // Catch:{ all -> 0x00fc }
            boolean r2 = r2.exists(r3)     // Catch:{ all -> 0x00fc }
        ...
        L_0x002c:
            r11.abort()     // Catch:{ all -> 0x00fc }
            java.lang.IllegalStateException r2 = new java.lang.IllegalStateException     // Catch:{ all -> 0x00fc }
        ...
        public Sink newSink(int index) {
            synchronized (DiskLruCache.this) {
                if (this.done) {
                    ...
                    try {
                        C24731 r3 = new FaultHidingSink(DiskLruCache.this.fileSystem.sink(this.entry.dirtyFiles[index])) {
                            /* access modifiers changed from: protected */
                            public void onException(IOException e) {
                                synchronized (DiskLruCache.this) {
                                    Editor.this.detach();
