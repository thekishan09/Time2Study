...
public final class CacheInterceptor implements Interceptor {
    ...
    static boolean isEndToEnd(String fieldName) {
        return !com.google.common.net.HttpHeaders.CONNECTION.equalsIgnoreCase(fieldName) && !"Keep-Alive".equalsIgnoreCase(fieldName) && !com.google.common.net.HttpHeaders.PROXY_AUTHENTICATE.equalsIgnoreCase(fieldName) && !com.google.common.net.HttpHeaders.PROXY_AUTHORIZATION.equalsIgnoreCase(fieldName) && !com.google.common.net.HttpHeaders.f396TE.equalsIgnoreCase(fieldName) && !"Trailers".equalsIgnoreCase(fieldName) && !com.google.common.net.HttpHeaders.TRANSFER_ENCODING.equalsIgnoreCase(fieldName) && !com.google.common.net.HttpHeaders.UPGRADE.equalsIgnoreCase(fieldName);
    }
