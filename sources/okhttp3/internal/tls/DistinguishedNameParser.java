...
final class DistinguishedNameParser {
        ...
        if (i4 < this.length) {
            ...
            if (this.chars[i4] == ' ') {
                ...
                if (cArr3[i6] != '=' || i6 == this.length) {
                    throw new IllegalStateException("Unexpected end of DN: " + this.f566dn);
                }
            }
            this.pos++;
            while (true) {
    ...
    private int getByte(int position) {
        ...
        if (position + 1 < this.length) {
            ...
            if (b12 >= '0' && b12 <= '9') {
                ...
                throw new IllegalStateException("Malformed DN: " + this.f566dn);
            } else {
                b1 = b12 - '7';
            }
    ...
    public String findMostSpecific(String attributeType) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f566dn.toCharArray();
