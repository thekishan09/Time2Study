...
final class Hpack {
    ...
    static final class Reader {
        ...
        public ByteString readByteString() throws IOException {
            ...
            if (huffmanDecode) {
                return ByteString.m601of(Huffman.get().decode(this.source.readByteArray((long) length)));
            }
